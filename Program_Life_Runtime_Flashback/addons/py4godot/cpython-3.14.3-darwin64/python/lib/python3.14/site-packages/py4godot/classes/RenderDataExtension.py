...
class RenderDataExtension(py4godot_renderdata.RenderData):
  ...
  def _get_render_scene_buffers(self) -> typing.Union['py4godot_renderscenebuffersrd.RenderSceneBuffersRD','py4godot_renderscenebuffers.RenderSceneBuffers','py4godot_renderscenebuffersextension.RenderSceneBuffersExtension']:
    r'''
  ...
  @functools.native_method
  def _get_render_scene_data(self) -> typing.Union['py4godot_renderscenedatard.RenderSceneDataRD','py4godot_renderscenedataextension.RenderSceneDataExtension','py4godot_renderscenedata.RenderSceneData']:
    r'''
