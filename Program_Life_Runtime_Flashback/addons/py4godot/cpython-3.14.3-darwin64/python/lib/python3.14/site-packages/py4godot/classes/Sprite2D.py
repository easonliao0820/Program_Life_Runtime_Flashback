...
class Sprite2D(py4godot_node2d.Node2D):
  ...
  def set_centered(self, centered:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(307,tuple([centered]))
  ...
  def set_offset(self, offset:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(309,tuple([offset._ptr]))
  ...
  def set_flip_h(self, flip_h:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(311,tuple([flip_h]))
  ...
  def set_flip_v(self, flip_v:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(313,tuple([flip_v]))
  ...
  def set_region_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(315,tuple([enabled]))
  ...
  def is_pixel_opaque(self, pos:'Vector2'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(317,tuple([pos._ptr]))
    return _ret
  ...
  def set_region_rect(self, rect:'Rect2'   ) -> None:
    ...
    self._ptr.call_with_return(318,tuple([rect._ptr]))
  ...
  def set_frame_coords(self, coords:'Vector2i'   ) -> None:
    ...
    self._ptr.call_with_return(324,tuple([coords._ptr]))
  ...
  def set_vframes(self, vframes:'int'   ) -> None:
    ...
    self._ptr.call_with_return(326,tuple([vframes]))
  ...
  def set_hframes(self, hframes:'int'   ) -> None:
    ...
    self._ptr.call_with_return(328,tuple([hframes]))
