...
class Performance(py4godot_object.Object):
  ...
  def instance():
    ...
    if _Performance_singleton_instance is None:
      ...
      singleton._ptr = constructor(931,0, ())
  ...
  @functools.native_method
  def add_custom_monitor(self, id:'object'   , callable:'Callable'   , arguments:'Array' = None  , type:'int'  =0) -> None:
    r'''
    ...
    self._ptr.call_with_return(50,tuple([py_stringname_id._ptr, callable._ptr, arguments._ptr, type]))
  ...
  @functools.native_method
  def get_custom_monitor_types(self) -> typing.Union['PackedInt32Array']:
    r'''
