...
class Image(py4godot_resource.Resource):
  ...
  def constructor():
    ...
    class_._ptr = constructor(1074,0, ())
    return class_
  @staticmethod
  def new():
    class_ = Image.construct_without_init()
  ...
  def __del__(self):
    if self.casted_from is None:
      self._ptr.call_with_return(149, ())
      self._ptr = None
  @staticmethod
  ...
  def resize(self, width:'int'   , height:'int'   , interpolation:'int'  =1) -> None:
    r'''
				...
				**Note:** If the image's format is `constant FORMAT_RGBA4444`, `constant FORMAT_RGB565`, or `constant FORMAT_RGBE9995`, it will be temporarily converted to either `constant FORMAT_RGBA8` or `constant FORMAT_RGBAH`. This can affect the quality of the resized image.
			'''
  ...
  def create(width:'int'   , height:'int'   , use_mipmaps:'bool'   , format:'int'  ) -> typing.Union['typing.Self']:
    ...
    _ret._ptr = static_method(1074,1,tuple([width, height, use_mipmaps, format]))
  ...
  def create_empty(width:'int'   , height:'int'   , use_mipmaps:'bool'   , format:'int'  ) -> typing.Union['typing.Self']:
    ...
    _ret = Image.construct_without_init()
    _ret._ptr = static_method(1074,2,tuple([width, height, use_mipmaps, format]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def create_from_data(width:'int'   , height:'int'   , use_mipmaps:'bool'   , format:'int'  , data:'PackedByteArray'   ) -> typing.Union['typing.Self']:
    ...
    _ret = Image.construct_without_init()
    _ret._ptr = static_method(1074,3,tuple([width, height, use_mipmaps, format, data._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def load_from_file(path:'str'   ) -> typing.Union['typing.Self']:
    ...
    _ret = Image.construct_without_init()
    _ret._ptr = static_method(1074,4,tuple([py_string_path._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  @functools.native_method
  def load_exr_from_buffer(self, buffer:'PackedByteArray'   ) -> typing.Union[int]:
    r'''
    ...
    _ret:int
    _ret = self._ptr.call_with_return(146,tuple([buffer._ptr]))
    return _ret
  ...
  def load_svg_from_buffer(self, buffer:'PackedByteArray'   , scale:'float' =1.0  ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = self._ptr.call_with_return(147,tuple([buffer._ptr, scale]))
    return _ret
  ...
  def load_svg_from_string(self, svg_str:'str'   , scale:'float' =1.0  ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = self._ptr.call_with_return(148,tuple([py_string_svg_str._ptr, scale]))
    return _ret
