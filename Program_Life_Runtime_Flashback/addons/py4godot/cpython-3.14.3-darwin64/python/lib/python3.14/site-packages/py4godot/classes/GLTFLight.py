...
class GLTFLight(py4godot_resource.Resource):
  ...
  def from_node(light_node:'py4godot_light3d.Light3D'   ) -> typing.Union['typing.Self']:
    ...
    _ret._ptr = static_method(460,1,tuple([light_node._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def to_node(self) -> typing.Union['py4godot_spotlight3d.SpotLight3D','py4godot_light3d.Light3D','py4godot_omnilight3d.OmniLight3D','py4godot_directionallight3d.DirectionalLight3D']:
    r''''''
  ...
  def from_dictionary(dictionary:'Dictionary'   ) -> typing.Union['typing.Self']:
    ...
    _ret = GLTFLight.construct_without_init()
    _ret._ptr = static_method(460,2,tuple([dictionary._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
