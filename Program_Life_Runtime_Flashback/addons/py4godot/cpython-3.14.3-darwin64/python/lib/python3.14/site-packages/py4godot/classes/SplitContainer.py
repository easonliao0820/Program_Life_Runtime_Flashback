...
if typing.TYPE_CHECKING:
  ...
  import py4godot.classes.ControlTypedArray as py4godot_controltypedarray 
...
class SplitContainer(py4godot_container.Container):
  ...
  @property
  def split_offsets(self) -> typing.Union['PackedInt32Array']:
    r''''''
    _ret = self. get_split_offsets()
    return _ret
  @split_offsets.setter
  def split_offsets(self,  value:'PackedInt32Array'):
    self.set_split_offsets(value)
  @property
  ...
  def set_split_offsets(self, offsets:'PackedInt32Array'   ) -> None:
    r''''''

    assert(not offsets is None)
    assert isinstance(offsets, PackedInt32Array), 'offsets must be PackedInt32Array'


    self.py__split_offsets = offsets
    ...
    self._ptr.call_with_return(442,tuple([offsets._ptr]))

  @functools.native_method
  def get_split_offsets(self) -> typing.Union['PackedInt32Array']:
    r''''''
  ...
  @functools.native_method
  def clamp_split_offset(self, priority_index:'int' =0  ) -> None:
    r'''
    ...
    assert isinstance(priority_index, (int, float)), 'priority_index must be int or float'
    ...
    self._ptr.call_with_return(444,tuple([priority_index]))
  ...
  def set_collapsed(self, collapsed:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(445,tuple([collapsed]))
  ...
  def set_dragger_visibility(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(447,tuple([mode]))
  ...
  def set_vertical(self, vertical:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(449,tuple([vertical]))
  ...
  def set_dragging_enabled(self, dragging_enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(451,tuple([dragging_enabled]))
  ...
  def set_drag_area_margin_begin(self, margin:'int'   ) -> None:
    ...
    self._ptr.call_with_return(453,tuple([margin]))
  ...
  def set_drag_area_margin_end(self, margin:'int'   ) -> None:
    ...
    self._ptr.call_with_return(455,tuple([margin]))
  ...
  def set_drag_area_offset(self, offset:'int'   ) -> None:
    ...
    self._ptr.call_with_return(457,tuple([offset]))
  ...
  def set_drag_area_highlight_in_editor(self, drag_area_highlight_in_editor:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(459,tuple([drag_area_highlight_in_editor]))
  ...
  @functools.native_method
  def get_drag_area_controls(self) -> typing.Union['py4godot_controltypedarray.ControlTypedArray']:
    r'''
				...
				```
				**Note:** The drag area `Control`s are drawn over the `SplitContainer`'s children, so `CanvasItem` draw objects called from a drag area and children added to it will also appear over the `SplitContainer`'s children. Try setting `Control.mouse_filter` of custom children to `constant Control.MOUSE_FILTER_IGNORE` to prevent blocking the mouse from dragging if desired.
    ...
    _ret = py4godot_controltypedarray.ControlTypedArray.construct_without_init()
  ...
  def set_touch_dragger_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(462,tuple([enabled]))
  ...
  def set_split_offset(self, offset:'int'   ) -> None:
    ...
    self._ptr.call_with_return(465,tuple([offset]))
