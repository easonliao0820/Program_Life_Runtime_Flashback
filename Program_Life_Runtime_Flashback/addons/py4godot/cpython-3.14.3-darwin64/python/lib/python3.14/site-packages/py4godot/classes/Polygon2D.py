...
class Polygon2D(py4godot_node2d.Node2D):
  ...
  def set_polygon(self, polygon:'PackedVector2Array'   ) -> None:
    ...
    self._ptr.call_with_return(305,tuple([polygon._ptr]))
  ...
  def set_uv(self, uv:'PackedVector2Array'   ) -> None:
    ...
    self._ptr.call_with_return(307,tuple([uv._ptr]))
  ...
  def set_color(self, color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(309,tuple([color._ptr]))
  ...
  def set_polygons(self, polygons:'Array'   ) -> None:
    ...
    self._ptr.call_with_return(311,tuple([polygons._ptr]))
  ...
  def set_vertex_colors(self, vertex_colors:'PackedColorArray'   ) -> None:
    ...
    self._ptr.call_with_return(313,tuple([vertex_colors._ptr]))
  ...
  def set_texture(self, texture:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(315,tuple([texture._ptr]))
  ...
  def set_texture_offset(self, texture_offset:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(317,tuple([texture_offset._ptr]))
  ...
  def set_texture_rotation(self, texture_rotation:'float'   ) -> None:
    ...
    self._ptr.call_with_return(319,tuple([texture_rotation]))
  ...
  def set_texture_scale(self, texture_scale:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(321,tuple([texture_scale._ptr]))
  ...
  def set_invert_enabled(self, invert:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(323,tuple([invert]))
  ...
  def set_antialiased(self, antialiased:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(325,tuple([antialiased]))
  ...
  def set_invert_border(self, invert_border:'float'   ) -> None:
    ...
    self._ptr.call_with_return(327,tuple([invert_border]))
  ...
  def set_offset(self, offset:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(329,tuple([offset._ptr]))
  ...
  def add_bone(self, path:'object'   , weights:'PackedFloat32Array'   ) -> None:
    ...
    self._ptr.call_with_return(331,tuple([py_nodepath_path._ptr, weights._ptr]))
  ...
  def get_bone_path(self, index:'int'   ) -> typing.Union['NodePath']:
    ...
    _ret._ptr = self._ptr.call_with_return(333,tuple([index]))
    return _ret
  ...
  def get_bone_weights(self, index:'int'   ) -> typing.Union['PackedFloat32Array']:
    ...
    _ret._ptr = self._ptr.call_with_return(334,tuple([index]))
    return _ret
  ...
  def erase_bone(self, index:'int'   ) -> None:
    ...
    self._ptr.call_with_return(335,tuple([index]))
  ...
  def set_bone_path(self, index:'int'   , path:'object'   ) -> None:
    ...
    self._ptr.call_with_return(337,tuple([index, py_nodepath_path._ptr]))
  ...
  def set_bone_weights(self, index:'int'   , weights:'PackedFloat32Array'   ) -> None:
    ...
    self._ptr.call_with_return(338,tuple([index, weights._ptr]))
  ...
  def set_skeleton(self, skeleton:'object'   ) -> None:
    ...
    self._ptr.call_with_return(339,tuple([py_nodepath_skeleton._ptr]))
  ...
  def set_internal_vertex_count(self, internal_vertex_count:'int'   ) -> None:
    ...
    self._ptr.call_with_return(341,tuple([internal_vertex_count]))
