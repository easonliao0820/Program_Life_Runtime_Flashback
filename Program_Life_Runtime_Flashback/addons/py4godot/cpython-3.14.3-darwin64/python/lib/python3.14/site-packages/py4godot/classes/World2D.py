...
class World2D(py4godot_resource.Resource):
  ...
  def space(self) -> typing.Union['RID']:
    ...
    return _ret
  @property
  def direct_space_state(self) -> typing.Union['py4godot_physicsdirectspacestate2d.PhysicsDirectSpaceState2D','py4godot_physicsdirectspacestate2dextension.PhysicsDirectSpaceState2DExtension']:
    r''''''
  ...
  @functools.native_method
  def get_direct_space_state(self) -> typing.Union['py4godot_physicsdirectspacestate2d.PhysicsDirectSpaceState2D','py4godot_physicsdirectspacestate2dextension.PhysicsDirectSpaceState2DExtension']:
    r''''''
