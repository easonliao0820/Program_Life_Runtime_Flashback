...
class AudioStreamRandomizer(py4godot_audiostream.AudioStream):
  ...
  @property
  def random_pitch_semitones(self) -> typing.Union[float]:
    r''''''
    _ret = self. get_random_pitch_semitones()
    return _ret
  @random_pitch_semitones.setter
  def random_pitch_semitones(self,  value:'float'):
    self.set_random_pitch_semitones(value)
  @property
  ...
  @functools.native_method
  def set_random_pitch_semitones(self, semitones:'float'   ) -> None:
    r''''''

    assert isinstance(semitones, (int, float)), 'semitones must be int or float'


    self.py__random_pitch_semitones = semitones
    ...
    self._ptr.call_with_return(104,tuple([semitones]))

  @functools.native_method
  def get_random_pitch_semitones(self) -> typing.Union[float]:
    r''''''
  ...
  def set_random_volume_offset_db(self, db_offset:'float'   ) -> None:
    ...
    self._ptr.call_with_return(106,tuple([db_offset]))
  ...
  def set_playback_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(108,tuple([mode]))
