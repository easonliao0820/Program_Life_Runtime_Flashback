...
class VisualShaderNodeParameter(py4godot_visualshadernode.VisualShaderNode):
  ...
  @property
  def instance_index(self) -> typing.Union[int]:
    r''''''
    _ret = self. get_instance_index()
    return _ret
  @instance_index.setter
  def instance_index(self,  value:'int'):
    self.set_instance_index(value)
  ...
  @functools.native_method
  def set_instance_index(self, instance_index:'int'   ) -> None:
    r''''''

    assert isinstance(instance_index, (int, float)), 'instance_index must be int or float'


    self.py__instance_index = instance_index
    ...
    self._ptr.call_with_return(92,tuple([instance_index]))

  @functools.native_method
  def get_instance_index(self) -> typing.Union[int]:
    r''''''
