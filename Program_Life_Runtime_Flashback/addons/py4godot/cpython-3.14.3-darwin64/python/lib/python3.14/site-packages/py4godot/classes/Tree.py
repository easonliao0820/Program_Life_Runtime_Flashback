...
class Tree(py4godot_control.Control):
  ...
  @property
  def enable_drag_unfolding(self) -> typing.Union[bool]:
    r''''''
    _ret = self. is_drag_unfolding_enabled()
    return _ret
  @enable_drag_unfolding.setter
  def enable_drag_unfolding(self,  value:'bool'):
    self.set_enable_drag_unfolding(value)
  @property
  ...
  def create_item(self, parent:'py4godot_treeitem.TreeItem' = None  , index:'int' =-1  ) -> typing.Union['py4godot_treeitem.TreeItem']:
    ...
    _ret._ptr = self._ptr.call_with_return(439,tuple([parent._ptr, index]))
  ...
  def set_column_custom_minimum_width(self, column:'int'   , min_width:'int'   ) -> None:
    ...
    self._ptr.call_with_return(441,tuple([column, min_width]))
  ...
  def set_column_expand(self, column:'int'   , expand:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(442,tuple([column, expand]))
  ...
  def set_column_expand_ratio(self, column:'int'   , ratio:'int'   ) -> None:
    ...
    self._ptr.call_with_return(443,tuple([column, ratio]))
  ...
  def set_column_clip_content(self, column:'int'   , enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(444,tuple([column, enable]))
  ...
  def is_column_expanding(self, column:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(445,tuple([column]))
    return _ret
  ...
  def is_column_clipping_content(self, column:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(446,tuple([column]))
    return _ret
  ...
  def get_column_expand_ratio(self, column:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(447,tuple([column]))
    return _ret
  ...
  def get_column_width(self, column:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(448,tuple([column]))
    return _ret
  ...
  def get_next_selected(self, from_:'py4godot_treeitem.TreeItem'   ) -> typing.Union['py4godot_treeitem.TreeItem']:
    ...
    _ret = classes.Object.Object.construct_without_init() #Smart casted to: TreeItem
    _ret._ptr = self._ptr.call_with_return(451,tuple([from_._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def set_selected(self, item:'py4godot_treeitem.TreeItem'   , column:'int'   ) -> None:
    ...
    self._ptr.call_with_return(453,tuple([item._ptr, column]))
  ...
  def set_select_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(456,tuple([mode]))
  ...
  def deselect_all(self) -> None:
    ...
    self._ptr.call_with_return(458,tuple([]))
  ...
  def set_columns(self, amount:'int'   ) -> None:
    ...
    self._ptr.call_with_return(459,tuple([amount]))
  ...
  def edit_selected(self, force_edit:'bool' =False  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(463,tuple([force_edit]))
    return _ret
  ...
  def get_item_area_rect(self, item:'py4godot_treeitem.TreeItem'   , column:'int' =-1  , button_index:'int' =-1  ) -> typing.Union['Rect2']:
    ...
    _ret = Rect2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(465,tuple([item._ptr, column, button_index]))
    return _ret
  ...
  def get_item_at_position(self, position:'Vector2'   ) -> typing.Union['py4godot_treeitem.TreeItem']:
    ...
    _ret = classes.Object.Object.construct_without_init() #Smart casted to: TreeItem
    _ret._ptr = self._ptr.call_with_return(466,tuple([position._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def get_column_at_position(self, position:'Vector2'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(467,tuple([position._ptr]))
    return _ret
  ...
  def get_drop_section_at_position(self, position:'Vector2'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(468,tuple([position._ptr]))
    return _ret
  ...
  def get_button_id_at_position(self, position:'Vector2'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(469,tuple([position._ptr]))
    return _ret
  ...
  def ensure_cursor_is_visible(self) -> None:
    ...
    self._ptr.call_with_return(470,tuple([]))
  ...
  def set_column_titles_visible(self, visible:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(471,tuple([visible]))
  ...
  def set_column_title(self, column:'int'   , title:'str'   ) -> None:
    ...
    self._ptr.call_with_return(473,tuple([column, py_string_title._ptr]))
  ...
  def get_column_title(self, column:'int'   ) -> typing.Union[str]:
    ...
    _ret._ptr = self._ptr.call_with_return(474,tuple([column]))
    return utils.gd_string_to_py_string(_ret)


  @functools.native_method
  def set_column_title_tooltip_text(self, column:'int'   , tooltip_text:'str'   ) -> None:
    r'''
				Sets the column title's tooltip text.
			'''

    assert isinstance(column, (int, float)), 'column must be int or float'
    assert(not tooltip_text is None)
    assert isinstance(tooltip_text, (str, String)), 'tooltip_text must be str or String'
    ...
    self._ptr.call_with_return(475,tuple([column, py_string_tooltip_text._ptr]))

  @functools.native_method
  def get_column_title_tooltip_text(self, column:'int'   ) -> typing.Union[str]:
    r'''
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(476,tuple([column]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def set_column_title_alignment(self, column:'int'   , title_alignment:'int'  ) -> None:
    ...
    self._ptr.call_with_return(477,tuple([column, title_alignment]))
  ...
  def get_column_title_alignment(self, column:'int'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = self._ptr.call_with_return(478,tuple([column]))
    return _ret
  ...
  def set_column_title_direction(self, column:'int'   , direction:'int'  ) -> None:
    ...
    self._ptr.call_with_return(479,tuple([column, direction]))
  ...
  def get_column_title_direction(self, column:'int'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = self._ptr.call_with_return(480,tuple([column]))
    return _ret
  ...
  def set_column_title_language(self, column:'int'   , language:'str'   ) -> None:
    ...
    self._ptr.call_with_return(481,tuple([column, py_string_language._ptr]))
  ...
  def get_column_title_language(self, column:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(482,tuple([column]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def scroll_to_item(self, item:'py4godot_treeitem.TreeItem'   , center_on_item:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(484,tuple([item._ptr, center_on_item]))
  ...
  def set_h_scroll_enabled(self, h_scroll:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(485,tuple([h_scroll]))
  ...
  def set_v_scroll_enabled(self, h_scroll:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(487,tuple([h_scroll]))
  ...
  def set_scroll_hint_mode(self, scroll_hint_mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(489,tuple([scroll_hint_mode]))
  ...
  def set_tile_scroll_hint(self, tile_scroll_hint:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(491,tuple([tile_scroll_hint]))
  ...
  def set_hide_folding(self, hide:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(493,tuple([hide]))
  ...
  @functools.native_method
  def set_enable_drag_unfolding(self, enable:'bool'   ) -> None:
    r''''''

    assert isinstance(enable, bool), 'enable must be bool'


    self.py__enable_drag_unfolding = enable
  ...
  @functools.native_method
  def is_drag_unfolding_enabled(self) -> typing.Union[bool]:
    r''''''
  ...
  def set_drop_mode_flags(self, flags:'int'   ) -> None:
    ...
    self._ptr.call_with_return(499,tuple([flags]))
  ...
  def set_allow_rmb_select(self, allow:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(501,tuple([allow]))
  ...
  def set_allow_reselect(self, allow:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(503,tuple([allow]))
  ...
  def set_allow_search(self, allow:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(505,tuple([allow]))
  ...
  def set_auto_tooltip(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(507,tuple([enable]))
