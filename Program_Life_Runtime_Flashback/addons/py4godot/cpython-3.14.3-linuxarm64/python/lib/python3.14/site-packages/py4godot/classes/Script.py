...
class Script(py4godot_resource.Resource):
  ...
  def constructor():
    ...
    class_._ptr = constructor(1080,0, ())
    return class_
  @staticmethod
  def new():
    class_ = Script.construct_without_init()
  ...
  @functools.native_method
  def get_base_script(self) -> typing.Union['py4godot_gdscript.GDScript','py4godot_scriptextension.ScriptExtension','typing.Self']:
    r'''
