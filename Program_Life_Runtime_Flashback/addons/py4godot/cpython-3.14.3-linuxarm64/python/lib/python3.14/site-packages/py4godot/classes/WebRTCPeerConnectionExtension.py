...
class WebRTCPeerConnectionExtension(py4godot_webrtcpeerconnection.WebRTCPeerConnection):
  ...
  @functools.native_method
  def _create_data_channel(self, p_label:'str'   , p_config:'Dictionary'   ) -> typing.Union['py4godot_webrtcdatachannelextension.WebRTCDataChannelExtension','py4godot_webrtcdatachannel.WebRTCDataChannel']:
    r''''''
