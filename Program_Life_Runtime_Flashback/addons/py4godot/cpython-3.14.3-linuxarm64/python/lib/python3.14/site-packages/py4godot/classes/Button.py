...
class Button(py4godot_basebutton.BaseButton):
  ...
  def set_text(self, text:'str'   ) -> None:
    ...
    self._ptr.call_with_return(463,tuple([py__string_text._ptr]))
  ...
  def set_text_overrun_behavior(self, overrun_behavior:'int'  ) -> None:
    ...
    self._ptr.call_with_return(465,tuple([overrun_behavior]))
  ...
  def set_autowrap_mode(self, autowrap_mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(467,tuple([autowrap_mode]))
  ...
  def set_autowrap_trim_flags(self, autowrap_trim_flags:'int'   ) -> None:
    ...
    self._ptr.call_with_return(469,tuple([autowrap_trim_flags]))
  ...
  def set_text_direction(self, direction:'int'  ) -> None:
    ...
    self._ptr.call_with_return(471,tuple([direction]))
  ...
  def set_language(self, language:'str'   ) -> None:
    ...
    self._ptr.call_with_return(473,tuple([py__string_language._ptr]))
  ...
  def set_button_icon(self, texture:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(475,tuple([texture._ptr]))
  ...
  def set_text_alignment(self, alignment:'int'  ) -> None:
    ...
    self._ptr.call_with_return(481,tuple([alignment]))
  ...
  def set_icon_alignment(self, icon_alignment:'int'  ) -> None:
    ...
    self._ptr.call_with_return(483,tuple([icon_alignment]))
  ...
  def set_vertical_icon_alignment(self, vertical_icon_alignment:'int'  ) -> None:
    ...
    self._ptr.call_with_return(485,tuple([vertical_icon_alignment]))
