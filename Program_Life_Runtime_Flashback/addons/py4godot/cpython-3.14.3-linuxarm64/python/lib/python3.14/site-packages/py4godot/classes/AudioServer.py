...
class AudioServer(py4godot_object.Object):
  ...
  def instance():
    ...
    if _AudioServer_singleton_instance is None:
      ...
      singleton._ptr = constructor(984,0, ())
  ...
  @functools.native_method
  def set_input_device_active(self, active:'bool'   ) -> typing.Union[int]:
    r'''
    ...
    _ret:int
    _ret = self._ptr.call_with_return(97,tuple([active]))
    return _ret


  @functools.native_method
  def get_input_frames_available(self) -> typing.Union[int]:
    r'''
  ...
  @functools.native_method
  def get_input_buffer_length_frames(self) -> typing.Union[int]:
    r'''
  ...
  @functools.native_method
  def get_input_frames(self, frames:'int'   ) -> typing.Union['PackedVector2Array']:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(100,tuple([frames]))
    return _ret
  ...
  def set_bus_layout(self, bus_layout:'py4godot_audiobuslayout.AudioBusLayout'   ) -> None:
    ...
    self._ptr.call_with_return(101,tuple([bus_layout._ptr]))
  ...
  def is_stream_registered_as_sample(self, stream:'py4godot_audiostream.AudioStream'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(104,tuple([stream._ptr]))
    return _ret
  ...
  def register_stream_as_sample(self, stream:'py4godot_audiostream.AudioStream'   ) -> None:
    ...
    self._ptr.call_with_return(105,tuple([stream._ptr]))
