...
class NativeMenu(py4godot_object.Object):
  ...
  def instance():
    ...
    if _NativeMenu_singleton_instance is None:
      ...
      singleton._ptr = constructor(941,0, ())
  ...
  @functools.native_method
  def get_system_menu_text(self, menu_id:'int'  ) -> typing.Union[str]:
    r'''
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(53,tuple([menu_id]))
    return utils.gd_string_to_py_string(_ret)


  @functools.native_method
  def set_system_menu_text(self, menu_id:'int'  , name:'str'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(54,tuple([menu_id, py_string_name._ptr]))
  ...
  def has_menu(self, rid:'RID'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(56,tuple([rid._ptr]))
    return _ret
  ...
  def free_menu(self, rid:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(57,tuple([rid._ptr]))
  ...
  def get_size(self, rid:'RID'   ) -> typing.Union['Vector2']:
    ...
    _ret._ptr = self._ptr.call_with_return(58,tuple([rid._ptr]))
    return _ret
  ...
  def popup(self, rid:'RID'   , position:'Vector2i'   ) -> None:
    ...
    self._ptr.call_with_return(59,tuple([rid._ptr, position._ptr]))
  ...
  def set_interface_direction(self, rid:'RID'   , is_rtl:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(60,tuple([rid._ptr, is_rtl]))
  ...
  def set_popup_close_callback(self, rid:'RID'   , callback:'Callable'   ) -> None:
    ...
    self._ptr.call_with_return(63,tuple([rid._ptr, callback._ptr]))
  ...
  def get_popup_close_callback(self, rid:'RID'   ) -> typing.Union['Callable']:
    ...
    _ret = Callable.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(64,tuple([rid._ptr]))
    return _ret
  ...
  def set_minimum_width(self, rid:'RID'   , width:'float'   ) -> None:
    ...
    self._ptr.call_with_return(65,tuple([rid._ptr, width]))
  ...
  def get_minimum_width(self, rid:'RID'   ) -> typing.Union[float]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(66,tuple([rid._ptr]))
    return _ret
  ...
  def is_opened(self, rid:'RID'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(67,tuple([rid._ptr]))
    return _ret
  ...
  def add_submenu_item(self, rid:'RID'   , label:'str'   , submenu_rid:'RID'   , tag:'object' =None  , index:'int' =-1  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(68,tuple([rid._ptr, py_string_label._ptr, submenu_rid._ptr, tag, index]))
    return _ret
  ...
  def add_item(self, rid:'RID'   , label:'str'   , callback:'Callable' = None  , key_callback:'Callable' = None  , tag:'object' =None  , accelerator:'int'  =0, index:'int' =-1  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(69,tuple([rid._ptr, py_string_label._ptr, callback._ptr, key_callback._ptr, tag, accelerator, index]))
    return _ret
  ...
  def add_check_item(self, rid:'RID'   , label:'str'   , callback:'Callable' = None  , key_callback:'Callable' = None  , tag:'object' =None  , accelerator:'int'  =0, index:'int' =-1  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(70,tuple([rid._ptr, py_string_label._ptr, callback._ptr, key_callback._ptr, tag, accelerator, index]))
    return _ret
  ...
  def add_icon_item(self, rid:'RID'   , icon:'py4godot_texture2d.Texture2D'   , label:'str'   , callback:'Callable' = None  , key_callback:'Callable' = None  , tag:'object' =None  , accelerator:'int'  =0, index:'int' =-1  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(71,tuple([rid._ptr, icon._ptr, py_string_label._ptr, callback._ptr, key_callback._ptr, tag, accelerator, index]))
    return _ret
  ...
  def add_radio_check_item(self, rid:'RID'   , label:'str'   , callback:'Callable' = None  , key_callback:'Callable' = None  , tag:'object' =None  , accelerator:'int'  =0, index:'int' =-1  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(73,tuple([rid._ptr, py_string_label._ptr, callback._ptr, key_callback._ptr, tag, accelerator, index]))
    return _ret
  ...
  def add_icon_radio_check_item(self, rid:'RID'   , icon:'py4godot_texture2d.Texture2D'   , label:'str'   , callback:'Callable' = None  , key_callback:'Callable' = None  , tag:'object' =None  , accelerator:'int'  =0, index:'int' =-1  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(74,tuple([rid._ptr, icon._ptr, py_string_label._ptr, callback._ptr, key_callback._ptr, tag, accelerator, index]))
    return _ret
  ...
  def add_multistate_item(self, rid:'RID'   , label:'str'   , max_states:'int'   , default_state:'int'   , callback:'Callable' = None  , key_callback:'Callable' = None  , tag:'object' =None  , accelerator:'int'  =0, index:'int' =-1  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(75,tuple([rid._ptr, py_string_label._ptr, max_states, default_state, callback._ptr, key_callback._ptr, tag, accelerator, index]))
    return _ret
  ...
  def add_separator(self, rid:'RID'   , index:'int' =-1  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(76,tuple([rid._ptr, index]))
    return _ret
  ...
  def find_item_index_with_text(self, rid:'RID'   , text:'str'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(77,tuple([rid._ptr, py_string_text._ptr]))
    return _ret
  ...
  def find_item_index_with_tag(self, rid:'RID'   , tag:'object'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(78,tuple([rid._ptr, tag]))
    return _ret
  ...
  def find_item_index_with_submenu(self, rid:'RID'   , submenu_rid:'RID'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(79,tuple([rid._ptr, submenu_rid._ptr]))
    return _ret
  ...
  def is_item_checkable(self, rid:'RID'   , idx:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(81,tuple([rid._ptr, idx]))
    return _ret
  ...
  def is_item_radio_checkable(self, rid:'RID'   , idx:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(82,tuple([rid._ptr, idx]))
    return _ret
  ...
  def get_item_callback(self, rid:'RID'   , idx:'int'   ) -> typing.Union['Callable']:
    ...
    _ret = Callable.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(83,tuple([rid._ptr, idx]))
    return _ret
  ...
  def get_item_tag(self, rid:'RID'   , idx:'int'   ) -> typing.Union[typing.Any]:
    ...
    _ret = None
    _ret = self._ptr.call_with_return(85,tuple([rid._ptr, idx]))
    return _ret
  ...
  def get_item_text(self, rid:'RID'   , idx:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(86,tuple([rid._ptr, idx]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def get_item_submenu(self, rid:'RID'   , idx:'int'   ) -> typing.Union['RID']:
    ...
    _ret = RID.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(87,tuple([rid._ptr, idx]))
    return _ret
  ...
  def is_item_disabled(self, rid:'RID'   , idx:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(89,tuple([rid._ptr, idx]))
    return _ret
  ...
  def get_item_tooltip(self, rid:'RID'   , idx:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(91,tuple([rid._ptr, idx]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def get_item_state(self, rid:'RID'   , idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(92,tuple([rid._ptr, idx]))
    return _ret
  ...
  def get_item_icon(self, rid:'RID'   , idx:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(94,tuple([rid._ptr, idx]))
  ...
  def get_item_indentation_level(self, rid:'RID'   , idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(95,tuple([rid._ptr, idx]))
    return _ret
  ...
  def set_item_checked(self, rid:'RID'   , idx:'int'   , checked:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(96,tuple([rid._ptr, idx, checked]))
  ...
  def set_item_checkable(self, rid:'RID'   , idx:'int'   , checkable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(97,tuple([rid._ptr, idx, checkable]))
  ...
  def set_item_radio_checkable(self, rid:'RID'   , idx:'int'   , checkable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(98,tuple([rid._ptr, idx, checkable]))
  ...
  def set_item_callback(self, rid:'RID'   , idx:'int'   , callback:'Callable'   ) -> None:
    ...
    self._ptr.call_with_return(99,tuple([rid._ptr, idx, callback._ptr]))
  ...
  def set_item_hover_callbacks(self, rid:'RID'   , idx:'int'   , callback:'Callable'   ) -> None:
    ...
    self._ptr.call_with_return(100,tuple([rid._ptr, idx, callback._ptr]))
  ...
  def set_item_key_callback(self, rid:'RID'   , idx:'int'   , key_callback:'Callable'   ) -> None:
    ...
    self._ptr.call_with_return(101,tuple([rid._ptr, idx, key_callback._ptr]))
  ...
  def set_item_tag(self, rid:'RID'   , idx:'int'   , tag:'object'   ) -> None:
    ...
    self._ptr.call_with_return(102,tuple([rid._ptr, idx, tag]))
  ...
  def set_item_text(self, rid:'RID'   , idx:'int'   , text:'str'   ) -> None:
    ...
    self._ptr.call_with_return(103,tuple([rid._ptr, idx, py_string_text._ptr]))
  ...
  def set_item_submenu(self, rid:'RID'   , idx:'int'   , submenu_rid:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(104,tuple([rid._ptr, idx, submenu_rid._ptr]))
  ...
  def set_item_accelerator(self, rid:'RID'   , idx:'int'   , keycode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(105,tuple([rid._ptr, idx, keycode]))
  ...
  def set_item_disabled(self, rid:'RID'   , idx:'int'   , disabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(106,tuple([rid._ptr, idx, disabled]))
  ...
  def set_item_hidden(self, rid:'RID'   , idx:'int'   , hidden:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(107,tuple([rid._ptr, idx, hidden]))
  ...
  def set_item_tooltip(self, rid:'RID'   , idx:'int'   , tooltip:'str'   ) -> None:
    ...
    self._ptr.call_with_return(108,tuple([rid._ptr, idx, py_string_tooltip._ptr]))
  ...
  def set_item_state(self, rid:'RID'   , idx:'int'   , state:'int'   ) -> None:
    ...
    self._ptr.call_with_return(109,tuple([rid._ptr, idx, state]))
  ...
  def set_item_max_states(self, rid:'RID'   , idx:'int'   , max_states:'int'   ) -> None:
    ...
    self._ptr.call_with_return(110,tuple([rid._ptr, idx, max_states]))
  ...
  def set_item_icon(self, rid:'RID'   , idx:'int'   , icon:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(111,tuple([rid._ptr, idx, icon._ptr]))
  ...
  def set_item_indentation_level(self, rid:'RID'   , idx:'int'   , level:'int'   ) -> None:
    ...
    self._ptr.call_with_return(112,tuple([rid._ptr, idx, level]))
  ...
  def get_item_count(self, rid:'RID'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(113,tuple([rid._ptr]))
    return _ret
  ...
  def is_system_menu(self, rid:'RID'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(114,tuple([rid._ptr]))
    return _ret
  ...
  def remove_item(self, rid:'RID'   , idx:'int'   ) -> None:
    ...
    self._ptr.call_with_return(115,tuple([rid._ptr, idx]))
  ...
  def clear(self, rid:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(116,tuple([rid._ptr]))
