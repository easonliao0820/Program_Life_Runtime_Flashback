...
'''
  ...
  def constructor():
    ...
    class_._ptr = constructor(1076,0, ())
    return class_
  @staticmethod
  def new():
    class_ = ScriptLanguageExtension.construct_without_init()
...
'''
  ...
  @functools.native_method
  def _make_template(self, template:'str'   , class_name:'str'   , base_class_name:'str'   ) -> typing.Union['py4godot_gdscript.GDScript','py4godot_scriptextension.ScriptExtension','py4godot_script.Script']:
    r'''
'''
