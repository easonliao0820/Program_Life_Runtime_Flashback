...
class Light2D(py4godot_node2d.Node2D):
  ...
  def set_editor_only(self, editor_only:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(307,tuple([editor_only]))
  ...
  def set_energy(self, energy:'float'   ) -> None:
    ...
    self._ptr.call_with_return(311,tuple([energy]))
  ...
  def set_z_range_max(self, z:'int'   ) -> None:
    ...
    self._ptr.call_with_return(315,tuple([z]))
  ...
  def set_layer_range_max(self, layer:'int'   ) -> None:
    ...
    self._ptr.call_with_return(319,tuple([layer]))
  ...
  def set_item_cull_mask(self, item_cull_mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(321,tuple([item_cull_mask]))
  ...
  def set_item_shadow_cull_mask(self, item_shadow_cull_mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(323,tuple([item_shadow_cull_mask]))
  ...
  def set_shadow_smooth(self, smooth:'float'   ) -> None:
    ...
    self._ptr.call_with_return(327,tuple([smooth]))
  ...
  def set_shadow_filter(self, filter:'int'  ) -> None:
    ...
    self._ptr.call_with_return(329,tuple([filter]))
  ...
  def set_shadow_color(self, shadow_color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(331,tuple([shadow_color._ptr]))
  ...
  def set_blend_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(333,tuple([mode]))
  ...
  def set_height(self, height:'float'   ) -> None:
    ...
    self._ptr.call_with_return(335,tuple([height]))
