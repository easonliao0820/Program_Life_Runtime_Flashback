...
'''
  ...
  def constructor():
    ...
    class_._ptr = constructor(1077,0, ())
    return class_
  @staticmethod
  def new():
    class_ = ScriptExtension.construct_without_init()
...
'''
  ...
  @functools.native_method
  def _get_base_script(self) -> typing.Union['py4godot_gdscript.GDScript','typing.Self','py4godot_script.Script']:
    r'''
'''
