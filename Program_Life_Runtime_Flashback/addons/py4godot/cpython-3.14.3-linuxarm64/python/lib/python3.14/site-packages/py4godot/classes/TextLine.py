...
class TextLine(py4godot_refcounted.RefCounted):
  ...
  def duplicate(self) -> typing.Union['typing.Self']:
    ...
    _ret = TextLine.construct_without_init()
  ...
  def set_orientation(self, orientation:'int'  ) -> None:
    ...
    self._ptr.call_with_return(58,tuple([orientation]))
  ...
  def set_bidi_override(self, override:'Array'   ) -> None:
    ...
    self._ptr.call_with_return(64,tuple([override._ptr]))
  ...
  def add_string(self, text:'str'   , font:'py4godot_font.Font'   , font_size:'int'   , language:'str' =""  , meta:'object' =None  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(65,tuple([py_string_text._ptr, font._ptr, font_size, py_string_language._ptr, meta]))
    return _ret
  ...
  def add_object(self, key:'object'   , size:'Vector2'   , inline_align:'int'  =5, length:'int' =1  , baseline:'float' =0.0  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(66,tuple([key, size._ptr, inline_align, length, baseline]))
    return _ret
  ...
  def resize_object(self, key:'object'   , size:'Vector2'   , inline_align:'int'  =5, baseline:'float' =0.0  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(67,tuple([key, size._ptr, inline_align, baseline]))
    return _ret
  ...
  def has_object(self, key:'object'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(68,tuple([key]))
    return _ret
  ...
  def set_width(self, width:'float'   ) -> None:
    ...
    self._ptr.call_with_return(69,tuple([width]))
  ...
  def set_text_overrun_behavior(self, overrun_behavior:'int'  ) -> None:
    ...
    self._ptr.call_with_return(76,tuple([overrun_behavior]))
  ...
  def set_ellipsis_char(self, char:'str'   ) -> None:
    ...
    self._ptr.call_with_return(78,tuple([py__string_char._ptr]))
  ...
  def get_object_rect(self, key:'object'   ) -> typing.Union['Rect2']:
    ...
    _ret._ptr = self._ptr.call_with_return(81,tuple([key]))
    return _ret
  ...
  def draw(self, canvas:'RID'   , pos:'Vector2'   , color:'Color' = None  , oversampling:'float' =0.0  ) -> None:
    ...
    self._ptr.call_with_return(89,tuple([canvas._ptr, pos._ptr, color._ptr, oversampling]))
  ...
  def draw_outline(self, canvas:'RID'   , pos:'Vector2'   , outline_size:'int' =1  , color:'Color' = None  , oversampling:'float' =0.0  ) -> None:
    ...
    self._ptr.call_with_return(90,tuple([canvas._ptr, pos._ptr, outline_size, color._ptr, oversampling]))
  ...
  def hit_test(self, coords:'float'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(91,tuple([coords]))
    return _ret
