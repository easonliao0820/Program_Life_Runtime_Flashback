...
class PopupMenu(py4godot_popup.Popup):
  ...
  @property
  def shrink_height(self) -> typing.Union[bool]:
    r''''''
    _ret = self. get_shrink_height()
    return _ret
  @shrink_height.setter
  def shrink_height(self,  value:'bool'):
    self.set_shrink_height(value)
  @property
  def shrink_width(self) -> typing.Union[bool]:
    r''''''
    _ret = self. get_shrink_width()
    return _ret
  @shrink_width.setter
  def shrink_width(self,  value:'bool'):
    self.set_shrink_width(value)
  @property
  ...
  def activate_item_by_event(self, event:'py4godot_inputevent.InputEvent'   , for_global_only:'bool' =False  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(438,tuple([event._ptr, for_global_only]))
    return _ret
  ...
  def add_check_item(self, label:'str'   , id:'int' =-1  , accel:'int'  =0) -> None:
    ...
    self._ptr.call_with_return(444,tuple([py_string_label._ptr, id, accel]))
  ...
  def add_icon_check_item(self, texture:'py4godot_texture2d.Texture2D'   , label:'str'   , id:'int' =-1  , accel:'int'  =0) -> None:
    ...
    self._ptr.call_with_return(445,tuple([texture._ptr, py_string_label._ptr, id, accel]))
  ...
  def add_radio_check_item(self, label:'str'   , id:'int' =-1  , accel:'int'  =0) -> None:
    ...
    self._ptr.call_with_return(446,tuple([py_string_label._ptr, id, accel]))
  ...
  def add_icon_radio_check_item(self, texture:'py4godot_texture2d.Texture2D'   , label:'str'   , id:'int' =-1  , accel:'int'  =0) -> None:
    ...
    self._ptr.call_with_return(447,tuple([texture._ptr, py_string_label._ptr, id, accel]))
  ...
  def add_multistate_item(self, label:'str'   , max_states:'int'   , default_state:'int' =0  , id:'int' =-1  , accel:'int'  =0) -> None:
    ...
    self._ptr.call_with_return(448,tuple([py_string_label._ptr, max_states, default_state, id, accel]))
  ...
  def add_shortcut(self, shortcut:'py4godot_shortcut.Shortcut'   , id:'int' =-1  , global_:'bool' =False  , allow_echo:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(449,tuple([shortcut._ptr, id, global_, allow_echo]))
  ...
  def add_icon_shortcut(self, texture:'py4godot_texture2d.Texture2D'   , shortcut:'py4godot_shortcut.Shortcut'   , id:'int' =-1  , global_:'bool' =False  , allow_echo:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(450,tuple([texture._ptr, shortcut._ptr, id, global_, allow_echo]))
  ...
  def add_check_shortcut(self, shortcut:'py4godot_shortcut.Shortcut'   , id:'int' =-1  , global_:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(451,tuple([shortcut._ptr, id, global_]))
  ...
  def add_icon_check_shortcut(self, texture:'py4godot_texture2d.Texture2D'   , shortcut:'py4godot_shortcut.Shortcut'   , id:'int' =-1  , global_:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(452,tuple([texture._ptr, shortcut._ptr, id, global_]))
  ...
  def add_radio_check_shortcut(self, shortcut:'py4godot_shortcut.Shortcut'   , id:'int' =-1  , global_:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(453,tuple([shortcut._ptr, id, global_]))
  ...
  def add_icon_radio_check_shortcut(self, texture:'py4godot_texture2d.Texture2D'   , shortcut:'py4godot_shortcut.Shortcut'   , id:'int' =-1  , global_:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(454,tuple([texture._ptr, shortcut._ptr, id, global_]))
  ...
  def add_submenu_item(self, label:'str'   , submenu:'str'   , id:'int' =-1  ) -> None:
    ...
    self._ptr.call_with_return(455,tuple([py_string_label._ptr, py_string_submenu._ptr, id]))
  ...
  def add_submenu_node_item(self, label:'str'   , submenu:'PopupMenu'   , id:'int' =-1  ) -> None:
    ...
    self._ptr.call_with_return(456,tuple([py_string_label._ptr, submenu._ptr, id]))
  ...
  def set_item_text(self, index:'int'   , text:'str'   ) -> None:
    ...
    self._ptr.call_with_return(457,tuple([index, py_string_text._ptr]))
  ...
  def set_item_text_direction(self, index:'int'   , direction:'int'  ) -> None:
    ...
    self._ptr.call_with_return(458,tuple([index, direction]))
  ...
  def set_item_language(self, index:'int'   , language:'str'   ) -> None:
    ...
    self._ptr.call_with_return(459,tuple([index, py_string_language._ptr]))
  ...
  def set_item_auto_translate_mode(self, index:'int'   , mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(460,tuple([index, mode]))
  ...
  def set_item_icon(self, index:'int'   , icon:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(461,tuple([index, icon._ptr]))
  ...
  def set_item_icon_max_width(self, index:'int'   , width:'int'   ) -> None:
    ...
    self._ptr.call_with_return(462,tuple([index, width]))
  ...
  def set_item_icon_modulate(self, index:'int'   , modulate:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(463,tuple([index, modulate._ptr]))
  ...
  def set_item_checked(self, index:'int'   , checked:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(464,tuple([index, checked]))
  ...
  def set_item_id(self, index:'int'   , id:'int'   ) -> None:
    ...
    self._ptr.call_with_return(465,tuple([index, id]))
  ...
  def set_item_accelerator(self, index:'int'   , accel:'int'  ) -> None:
    ...
    self._ptr.call_with_return(466,tuple([index, accel]))
  ...
  def set_item_metadata(self, index:'int'   , metadata:'object'   ) -> None:
    ...
    self._ptr.call_with_return(467,tuple([index, metadata]))
  ...
  def set_item_disabled(self, index:'int'   , disabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(468,tuple([index, disabled]))
  ...
  def set_item_submenu(self, index:'int'   , submenu:'str'   ) -> None:
    ...
    self._ptr.call_with_return(469,tuple([index, py_string_submenu._ptr]))
  ...
  def set_item_submenu_node(self, index:'int'   , submenu:'PopupMenu'   ) -> None:
    ...
    self._ptr.call_with_return(470,tuple([index, submenu._ptr]))
  ...
  def set_item_as_separator(self, index:'int'   , enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(471,tuple([index, enable]))
  ...
  def set_item_as_checkable(self, index:'int'   , enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(472,tuple([index, enable]))
  ...
  def set_item_as_radio_checkable(self, index:'int'   , enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(473,tuple([index, enable]))
  ...
  def set_item_tooltip(self, index:'int'   , tooltip:'str'   ) -> None:
    ...
    self._ptr.call_with_return(474,tuple([index, py_string_tooltip._ptr]))
  ...
  def set_item_shortcut(self, index:'int'   , shortcut:'py4godot_shortcut.Shortcut'   , global_:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(475,tuple([index, shortcut._ptr, global_]))
  ...
  def set_item_indent(self, index:'int'   , indent:'int'   ) -> None:
    ...
    self._ptr.call_with_return(476,tuple([index, indent]))
  ...
  def set_item_multistate(self, index:'int'   , state:'int'   ) -> None:
    ...
    self._ptr.call_with_return(477,tuple([index, state]))
  ...
  def set_item_multistate_max(self, index:'int'   , max_states:'int'   ) -> None:
    ...
    self._ptr.call_with_return(478,tuple([index, max_states]))
  ...
  def set_item_shortcut_disabled(self, index:'int'   , disabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(479,tuple([index, disabled]))
  ...
  def toggle_item_checked(self, index:'int'   ) -> None:
    ...
    self._ptr.call_with_return(480,tuple([index]))
  ...
  def toggle_item_multistate(self, index:'int'   ) -> None:
    ...
    self._ptr.call_with_return(481,tuple([index]))
  ...
  def get_item_icon(self, index:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(486,tuple([index]))
  ...
  def get_item_icon_max_width(self, index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(487,tuple([index]))
    return _ret
  ...
  def get_item_icon_modulate(self, index:'int'   ) -> typing.Union['Color']:
    ...
    _ret._ptr = self._ptr.call_with_return(488,tuple([index]))
    return _ret
  ...
  def get_item_index(self, id:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(491,tuple([id]))
    return _ret
  ...
  def get_item_accelerator(self, index:'int'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = self._ptr.call_with_return(492,tuple([index]))
    return _ret
  ...
  def get_item_submenu(self, index:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(495,tuple([index]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def get_item_submenu_node(self, index:'int'   ) -> typing.Union['typing.Self']:
    ...
    _ret._ptr = self._ptr.call_with_return(496,tuple([index]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def is_item_separator(self, index:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(497,tuple([index]))
    return _ret
  ...
  def is_item_checkable(self, index:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(498,tuple([index]))
    return _ret
  ...
  def get_item_tooltip(self, index:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(501,tuple([index]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def get_item_shortcut(self, index:'int'   ) -> typing.Union['py4godot_shortcut.Shortcut']:
    ...
    _ret._ptr = self._ptr.call_with_return(502,tuple([index]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def get_item_indent(self, index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(503,tuple([index]))
    return _ret
  ...
  def get_item_multistate_max(self, index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(504,tuple([index]))
    return _ret
  ...
  def get_item_multistate(self, index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(505,tuple([index]))
    return _ret
  ...
  def set_item_count(self, count:'int'   ) -> None:
    ...
    self._ptr.call_with_return(508,tuple([count]))
  ...
  def scroll_to_item(self, index:'int'   ) -> None:
    ...
    self._ptr.call_with_return(510,tuple([index]))
  ...
  def remove_item(self, index:'int'   ) -> None:
    ...
    self._ptr.call_with_return(511,tuple([index]))
  ...
  def add_separator(self, label:'str' =""  , id:'int' =-1  ) -> None:
    ...
    self._ptr.call_with_return(512,tuple([py_string_label._ptr, id]))
  ...
  def clear(self, free_submenus:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(513,tuple([free_submenus]))
  ...
  def set_submenu_popup_delay(self, seconds:'float'   ) -> None:
    ...
    self._ptr.call_with_return(520,tuple([seconds]))
  ...
  def set_allow_search(self, allow:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(522,tuple([allow]))
  ...
  def set_system_menu(self, system_menu_id:'int'  ) -> None:
    ...
    self._ptr.call_with_return(525,tuple([system_menu_id]))
  ...
  @functools.native_method
  def set_shrink_height(self, shrink:'bool'   ) -> None:
    r''''''

    assert isinstance(shrink, bool), 'shrink must be bool'


    self.py__shrink_height = shrink
    ...
    self._ptr.call_with_return(527,tuple([shrink]))

  @functools.native_method
  def get_shrink_height(self) -> typing.Union[bool]:
    r''''''
  ...
  @functools.native_method
  def set_shrink_width(self, shrink:'bool'   ) -> None:
    r''''''

    assert isinstance(shrink, bool), 'shrink must be bool'


    self.py__shrink_width = shrink
    ...
    self._ptr.call_with_return(529,tuple([shrink]))

  @functools.native_method
  def get_shrink_width(self) -> typing.Union[bool]:
    r''''''
