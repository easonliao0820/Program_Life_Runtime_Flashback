...
class MultiMesh(py4godot_resource.Resource):
  ...
  @functools.native_method
  def reset_instances_physics_interpolation(self) -> None:
    r'''
				When using _physics interpolation_, this function allows you to prevent interpolation for all instances in the current physics tick.
  ...
  def set_custom_aabb(self, aabb:'AABB'   ) -> None:
    ...
    self._ptr.call_with_return(101,tuple([aabb._ptr]))
  ...
  def set_buffer(self, buffer:'PackedFloat32Array'   ) -> None:
    ...
    self._ptr.call_with_return(105,tuple([buffer._ptr]))
  ...
  def set_buffer_interpolated(self, buffer_curr:'PackedFloat32Array'   , buffer_prev:'PackedFloat32Array'   ) -> None:
    ...
    self._ptr.call_with_return(106,tuple([buffer_curr._ptr, buffer_prev._ptr]))
