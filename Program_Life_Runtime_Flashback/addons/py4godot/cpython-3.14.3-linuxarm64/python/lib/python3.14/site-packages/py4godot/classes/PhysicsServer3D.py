...
class PhysicsServer3D(py4godot_object.Object):
  ...
  def instance():
    ...
    if _PhysicsServer3D_singleton_instance is None:
      ...
      singleton._ptr = constructor(920,0, ())
  ...
  @functools.native_method
  def space_get_direct_state(self, space:'RID'   ) -> typing.Union['py4godot_physicsdirectspacestate3dextension.PhysicsDirectSpaceState3DExtension','py4godot_physicsdirectspacestate3d.PhysicsDirectSpaceState3D']:
    r'''
