...
'''
    ...
    self._ptr.call_with_return(454,tuple([slot_index, position._ptr, left, color._ptr]))
  ...
  def set_title(self, title:'str'   ) -> None:
    ...
    self._ptr.call_with_return(455,tuple([py__string_title._ptr]))
  ...
  def set_slot(self, slot_index:'int'   , enable_left_port:'bool'   , type_left:'int'   , color_left:'Color'   , enable_right_port:'bool'   , type_right:'int'   , color_right:'Color'   , custom_icon_left:'py4godot_texture2d.Texture2D' = None  , custom_icon_right:'py4godot_texture2d.Texture2D' = None  , draw_stylebox:'bool' =True  ) -> None:
    ...
    self._ptr.call_with_return(458,tuple([slot_index, enable_left_port, type_left, color_left._ptr, enable_right_port, type_right, color_right._ptr, custom_icon_left._ptr, custom_icon_right._ptr, draw_stylebox]))
  ...
  def clear_slot(self, slot_index:'int'   ) -> None:
    ...
    self._ptr.call_with_return(459,tuple([slot_index]))
  ...
  def clear_all_slots(self) -> None:
    ...
    self._ptr.call_with_return(460,tuple([]))
  ...
  def is_slot_enabled_left(self, slot_index:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(461,tuple([slot_index]))
    return _ret
  ...
  def set_slot_enabled_left(self, slot_index:'int'   , enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(462,tuple([slot_index, enable]))
  ...
  def set_slot_type_left(self, slot_index:'int'   , type:'int'   ) -> None:
    ...
    self._ptr.call_with_return(463,tuple([slot_index, type]))
  ...
  def get_slot_type_left(self, slot_index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(464,tuple([slot_index]))
    return _ret
  ...
  def set_slot_color_left(self, slot_index:'int'   , color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(465,tuple([slot_index, color._ptr]))
  ...
  def get_slot_color_left(self, slot_index:'int'   ) -> typing.Union['Color']:
    ...
    _ret._ptr = self._ptr.call_with_return(466,tuple([slot_index]))
    return _ret
  ...
  def set_slot_custom_icon_left(self, slot_index:'int'   , custom_icon:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(467,tuple([slot_index, custom_icon._ptr]))
  ...
  def get_slot_custom_icon_left(self, slot_index:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(468,tuple([slot_index]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def set_slot_metadata_left(self, slot_index:'int'   , value:'object'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(469,tuple([slot_index, value]))

  @functools.native_method
  def get_slot_metadata_left(self, slot_index:'int'   ) -> typing.Union[typing.Any]:
    r'''
  ...
  def is_slot_enabled_right(self, slot_index:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(471,tuple([slot_index]))
    return _ret
  ...
  def set_slot_enabled_right(self, slot_index:'int'   , enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(472,tuple([slot_index, enable]))
  ...
  def set_slot_type_right(self, slot_index:'int'   , type:'int'   ) -> None:
    ...
    self._ptr.call_with_return(473,tuple([slot_index, type]))
  ...
  def get_slot_type_right(self, slot_index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(474,tuple([slot_index]))
    return _ret
  ...
  def set_slot_color_right(self, slot_index:'int'   , color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(475,tuple([slot_index, color._ptr]))
  ...
  def get_slot_color_right(self, slot_index:'int'   ) -> typing.Union['Color']:
    ...
    _ret = Color.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(476,tuple([slot_index]))
    return _ret
  ...
  def set_slot_custom_icon_right(self, slot_index:'int'   , custom_icon:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(477,tuple([slot_index, custom_icon._ptr]))
  ...
  def get_slot_custom_icon_right(self, slot_index:'int'   ) -> typing.Any:
    ...
    _ret = classes.Object.Object.construct_without_init() #Smart casted to: Texture2D
    _ret._ptr = self._ptr.call_with_return(478,tuple([slot_index]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def set_slot_metadata_right(self, slot_index:'int'   , value:'object'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(479,tuple([slot_index, value]))

  @functools.native_method
  def get_slot_metadata_right(self, slot_index:'int'   ) -> typing.Union[typing.Any]:
    r'''
    ...
    _ret = None
    _ret = self._ptr.call_with_return(480,tuple([slot_index]))
    return _ret
  ...
  def is_slot_draw_stylebox(self, slot_index:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(481,tuple([slot_index]))
    return _ret
  ...
  def set_slot_draw_stylebox(self, slot_index:'int'   , enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(482,tuple([slot_index, enable]))
  ...
  def set_ignore_invalid_connection_type(self, ignore:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(483,tuple([ignore]))
  ...
  def set_slots_focus_mode(self, focus_mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(485,tuple([focus_mode]))
  ...
  def get_input_port_position(self, port_idx:'int'   ) -> typing.Union['Vector2']:
    ...
    _ret._ptr = self._ptr.call_with_return(488,tuple([port_idx]))
    return _ret
  ...
  def get_input_port_type(self, port_idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(489,tuple([port_idx]))
    return _ret
  ...
  def get_input_port_color(self, port_idx:'int'   ) -> typing.Union['Color']:
    ...
    _ret = Color.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(490,tuple([port_idx]))
    return _ret
  ...
  def get_input_port_slot(self, port_idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(491,tuple([port_idx]))
    return _ret
  ...
  def get_output_port_position(self, port_idx:'int'   ) -> typing.Union['Vector2']:
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(493,tuple([port_idx]))
    return _ret
  ...
  def get_output_port_type(self, port_idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(494,tuple([port_idx]))
    return _ret
  ...
  def get_output_port_color(self, port_idx:'int'   ) -> typing.Union['Color']:
    ...
    _ret = Color.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(495,tuple([port_idx]))
    return _ret
  ...
  def get_output_port_slot(self, port_idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(496,tuple([port_idx]))
    return _ret
