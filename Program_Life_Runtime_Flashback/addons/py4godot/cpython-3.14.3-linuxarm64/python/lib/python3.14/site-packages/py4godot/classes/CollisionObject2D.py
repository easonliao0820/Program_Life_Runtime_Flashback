...
class CollisionObject2D(py4godot_node2d.Node2D):
  ...
  def _input_event(self, viewport:'py4godot_viewport.Viewport'   , event:'py4godot_inputevent.InputEvent'   , shape_idx:'int'   ) -> None:
    ...
    self._ptr.call_with_return(305,tuple([viewport._ptr, event._ptr, shape_idx]))
  ...
  def _mouse_exit(self) -> None:
    ...
    self._ptr.call_with_return(307,tuple([]))
  ...
  def _mouse_shape_enter(self, shape_idx:'int'   ) -> None:
    ...
    self._ptr.call_with_return(308,tuple([shape_idx]))
  ...
  def _mouse_shape_exit(self, shape_idx:'int'   ) -> None:
    ...
    self._ptr.call_with_return(309,tuple([shape_idx]))
  ...
  def set_collision_layer(self, layer:'int'   ) -> None:
    ...
    self._ptr.call_with_return(311,tuple([layer]))
  ...
  def set_collision_mask(self, mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(313,tuple([mask]))
  ...
  def set_collision_mask_value(self, layer_number:'int'   , value:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(317,tuple([layer_number, value]))
  ...
  def get_collision_mask_value(self, layer_number:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(318,tuple([layer_number]))
    return _ret
  ...
  def set_collision_priority(self, priority:'float'   ) -> None:
    ...
    self._ptr.call_with_return(319,tuple([priority]))
  ...
  def set_disable_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(321,tuple([mode]))
  ...
  def create_shape_owner(self, owner:'py4godot_object.Object'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(325,tuple([owner._ptr]))
    return _ret
  ...
  def remove_shape_owner(self, owner_id:'int'   ) -> None:
    ...
    self._ptr.call_with_return(326,tuple([owner_id]))
  ...
  def shape_owner_set_transform(self, owner_id:'int'   , transform:'Transform2D'   ) -> None:
    ...
    self._ptr.call_with_return(328,tuple([owner_id, transform._ptr]))
  ...
  def shape_owner_get_transform(self, owner_id:'int'   ) -> typing.Union['Transform2D']:
    ...
    _ret._ptr = self._ptr.call_with_return(329,tuple([owner_id]))
    return _ret
  ...
  def shape_owner_get_owner(self, owner_id:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(330,tuple([owner_id]))
  ...
  def shape_owner_set_disabled(self, owner_id:'int'   , disabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(331,tuple([owner_id, disabled]))
  ...
  def shape_owner_set_one_way_collision(self, owner_id:'int'   , enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(333,tuple([owner_id, enable]))
  ...
  def shape_owner_set_one_way_collision_margin(self, owner_id:'int'   , margin:'float'   ) -> None:
    ...
    self._ptr.call_with_return(335,tuple([owner_id, margin]))
  ...
  def shape_owner_add_shape(self, owner_id:'int'   , shape:'py4godot_shape2d.Shape2D'   ) -> None:
    ...
    self._ptr.call_with_return(337,tuple([owner_id, shape._ptr]))
  ...
  def shape_owner_get_shape_count(self, owner_id:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(338,tuple([owner_id]))
    return _ret
  ...
  def shape_owner_get_shape(self, owner_id:'int'   , shape_id:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(339,tuple([owner_id, shape_id]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def shape_owner_get_shape_index(self, owner_id:'int'   , shape_id:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(340,tuple([owner_id, shape_id]))
    return _ret
  ...
  def shape_owner_remove_shape(self, owner_id:'int'   , shape_id:'int'   ) -> None:
    ...
    self._ptr.call_with_return(341,tuple([owner_id, shape_id]))
  ...
  def shape_owner_clear_shapes(self, owner_id:'int'   ) -> None:
    ...
    self._ptr.call_with_return(342,tuple([owner_id]))
  ...
  def shape_find_owner(self, shape_index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(343,tuple([shape_index]))
    return _ret
