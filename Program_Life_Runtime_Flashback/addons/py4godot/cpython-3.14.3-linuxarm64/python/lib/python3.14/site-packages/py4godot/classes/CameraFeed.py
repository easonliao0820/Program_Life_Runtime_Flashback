...
class CameraFeed(py4godot_refcounted.RefCounted):
  ...
  @functools.native_method
  def set_ycbcr_images(self, y_image:'py4godot_image.Image'   , cbcr_image:'py4godot_image.Image'   ) -> None:
    r'''
				Sets Y and CbCr images for this feed.
			'''

    assert(not y_image is None)
    assert isinstance(y_image, get_class('Image')), 'y_image must be Image'
    assert(not cbcr_image is None)
    assert isinstance(cbcr_image, get_class('Image')), 'cbcr_image must be Image'
    ...
    self._ptr.call_with_return(66,tuple([y_image._ptr, cbcr_image._ptr]))
  ...
  def set_external(self, width:'int'   , height:'int'   ) -> None:
    ...
    self._ptr.call_with_return(67,tuple([width, height]))
  ...
  def get_texture_tex_id(self, feed_image_type:'int'  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(68,tuple([feed_image_type]))
    return _ret
  ...
  def set_format(self, index:'int'   , parameters:'Dictionary'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(71,tuple([index, parameters._ptr]))
    return _ret
