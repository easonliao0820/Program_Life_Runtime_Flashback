...
class Environment(py4godot_resource.Resource):
  ...
  def __del__(self):
    if self.casted_from is None:
      self._ptr.call_with_return(265, ())
      self._ptr = None
  @staticmethod
  ...
  @property
  def tonemap_agx_white(self) -> typing.Union[float]:
    r''''''
    _ret = self. get_tonemap_agx_white()
    return _ret
  @tonemap_agx_white.setter
  def tonemap_agx_white(self,  value:'float'):
    self.set_tonemap_agx_white(value)
  @property
  def tonemap_agx_contrast(self) -> typing.Union[float]:
    r''''''
    _ret = self. get_tonemap_agx_contrast()
    return _ret
  @tonemap_agx_contrast.setter
  def tonemap_agx_contrast(self,  value:'float'):
    self.set_tonemap_agx_contrast(value)
  @property
  ...
  @functools.native_method
  def set_tonemap_agx_white(self, white:'float'   ) -> None:
    r''''''

    assert isinstance(white, (int, float)), 'white must be int or float'


    self.py__tonemap_agx_white = white
    ...
    self._ptr.call_with_return(111,tuple([white]))

  @functools.native_method
  def get_tonemap_agx_white(self) -> typing.Union[float]:
    r''''''
  ...
  @functools.native_method
  def set_tonemap_agx_contrast(self, contrast:'float'   ) -> None:
    r''''''

    assert isinstance(contrast, (int, float)), 'contrast must be int or float'


    self.py__tonemap_agx_contrast = contrast
    ...
    self._ptr.call_with_return(113,tuple([contrast]))

  @functools.native_method
  def get_tonemap_agx_contrast(self) -> typing.Union[float]:
    r''''''
  ...
  def set_ssr_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(115,tuple([enabled]))
  ...
  def set_ssr_max_steps(self, max_steps:'int'   ) -> None:
    ...
    self._ptr.call_with_return(117,tuple([max_steps]))
  ...
  def set_ssr_fade_in(self, fade_in:'float'   ) -> None:
    ...
    self._ptr.call_with_return(119,tuple([fade_in]))
  ...
  def set_ssr_fade_out(self, fade_out:'float'   ) -> None:
    ...
    self._ptr.call_with_return(121,tuple([fade_out]))
  ...
  def set_ssr_depth_tolerance(self, depth_tolerance:'float'   ) -> None:
    ...
    self._ptr.call_with_return(123,tuple([depth_tolerance]))
  ...
  def set_ssao_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(125,tuple([enabled]))
  ...
  def set_ssao_radius(self, radius:'float'   ) -> None:
    ...
    self._ptr.call_with_return(127,tuple([radius]))
  ...
  def set_ssao_intensity(self, intensity:'float'   ) -> None:
    ...
    self._ptr.call_with_return(129,tuple([intensity]))
  ...
  def set_ssao_power(self, power:'float'   ) -> None:
    ...
    self._ptr.call_with_return(131,tuple([power]))
  ...
  def set_ssao_detail(self, detail:'float'   ) -> None:
    ...
    self._ptr.call_with_return(133,tuple([detail]))
  ...
  def set_ssao_horizon(self, horizon:'float'   ) -> None:
    ...
    self._ptr.call_with_return(135,tuple([horizon]))
  ...
  def set_ssao_sharpness(self, sharpness:'float'   ) -> None:
    ...
    self._ptr.call_with_return(137,tuple([sharpness]))
  ...
  def set_ssao_direct_light_affect(self, amount:'float'   ) -> None:
    ...
    self._ptr.call_with_return(139,tuple([amount]))
  ...
  def set_ssao_ao_channel_affect(self, amount:'float'   ) -> None:
    ...
    self._ptr.call_with_return(141,tuple([amount]))
  ...
  def set_ssil_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(143,tuple([enabled]))
  ...
  def set_ssil_radius(self, radius:'float'   ) -> None:
    ...
    self._ptr.call_with_return(145,tuple([radius]))
  ...
  def set_ssil_intensity(self, intensity:'float'   ) -> None:
    ...
    self._ptr.call_with_return(147,tuple([intensity]))
  ...
  def set_ssil_sharpness(self, sharpness:'float'   ) -> None:
    ...
    self._ptr.call_with_return(149,tuple([sharpness]))
  ...
  def set_ssil_normal_rejection(self, normal_rejection:'float'   ) -> None:
    ...
    self._ptr.call_with_return(151,tuple([normal_rejection]))
  ...
  def set_sdfgi_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(153,tuple([enabled]))
  ...
  def set_sdfgi_cascades(self, amount:'int'   ) -> None:
    ...
    self._ptr.call_with_return(155,tuple([amount]))
  ...
  def set_sdfgi_min_cell_size(self, size:'float'   ) -> None:
    ...
    self._ptr.call_with_return(157,tuple([size]))
  ...
  def set_sdfgi_max_distance(self, distance:'float'   ) -> None:
    ...
    self._ptr.call_with_return(159,tuple([distance]))
  ...
  def set_sdfgi_cascade0_distance(self, distance:'float'   ) -> None:
    ...
    self._ptr.call_with_return(161,tuple([distance]))
  ...
  def set_sdfgi_y_scale(self, scale:'int'  ) -> None:
    ...
    self._ptr.call_with_return(163,tuple([scale]))
  ...
  def set_sdfgi_energy(self, amount:'float'   ) -> None:
    ...
    self._ptr.call_with_return(171,tuple([amount]))
  ...
  def set_sdfgi_normal_bias(self, bias:'float'   ) -> None:
    ...
    self._ptr.call_with_return(173,tuple([bias]))
  ...
  def set_sdfgi_probe_bias(self, bias:'float'   ) -> None:
    ...
    self._ptr.call_with_return(175,tuple([bias]))
  ...
  def set_glow_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(177,tuple([enabled]))
  ...
  def set_glow_level(self, idx:'int'   , intensity:'float'   ) -> None:
    ...
    self._ptr.call_with_return(179,tuple([idx, intensity]))
  ...
  def get_glow_level(self, idx:'int'   ) -> typing.Union[float]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(180,tuple([idx]))
    return _ret
  ...
  def set_glow_normalized(self, normalize:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(181,tuple([normalize]))
  ...
  def set_glow_intensity(self, intensity:'float'   ) -> None:
    ...
    self._ptr.call_with_return(183,tuple([intensity]))
  ...
  def set_glow_strength(self, strength:'float'   ) -> None:
    ...
    self._ptr.call_with_return(185,tuple([strength]))
  ...
  def set_glow_mix(self, mix:'float'   ) -> None:
    ...
    self._ptr.call_with_return(187,tuple([mix]))
  ...
  def set_glow_bloom(self, amount:'float'   ) -> None:
    ...
    self._ptr.call_with_return(189,tuple([amount]))
  ...
  def set_glow_blend_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(191,tuple([mode]))
  ...
  def set_glow_hdr_bleed_threshold(self, threshold:'float'   ) -> None:
    ...
    self._ptr.call_with_return(193,tuple([threshold]))
  ...
  def set_glow_hdr_bleed_scale(self, scale:'float'   ) -> None:
    ...
    self._ptr.call_with_return(195,tuple([scale]))
  ...
  def set_glow_hdr_luminance_cap(self, amount:'float'   ) -> None:
    ...
    self._ptr.call_with_return(197,tuple([amount]))
  ...
  def set_glow_map_strength(self, strength:'float'   ) -> None:
    ...
    self._ptr.call_with_return(199,tuple([strength]))
  ...
  def set_glow_map(self, mode:'py4godot_texture.Texture'   ) -> None:
    ...
    self._ptr.call_with_return(201,tuple([mode._ptr]))
  ...
  def set_fog_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(203,tuple([enabled]))
  ...
  def set_fog_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(205,tuple([mode]))
  ...
  def set_fog_light_color(self, light_color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(207,tuple([light_color._ptr]))
  ...
  def set_fog_light_energy(self, light_energy:'float'   ) -> None:
    ...
    self._ptr.call_with_return(209,tuple([light_energy]))
  ...
  def set_fog_sun_scatter(self, sun_scatter:'float'   ) -> None:
    ...
    self._ptr.call_with_return(211,tuple([sun_scatter]))
  ...
  def set_fog_density(self, density:'float'   ) -> None:
    ...
    self._ptr.call_with_return(213,tuple([density]))
  ...
  def set_fog_height(self, height:'float'   ) -> None:
    ...
    self._ptr.call_with_return(215,tuple([height]))
  ...
  def set_fog_height_density(self, height_density:'float'   ) -> None:
    ...
    self._ptr.call_with_return(217,tuple([height_density]))
  ...
  def set_fog_aerial_perspective(self, aerial_perspective:'float'   ) -> None:
    ...
    self._ptr.call_with_return(219,tuple([aerial_perspective]))
  ...
  def set_fog_sky_affect(self, sky_affect:'float'   ) -> None:
    ...
    self._ptr.call_with_return(221,tuple([sky_affect]))
  ...
  def set_fog_depth_curve(self, curve:'float'   ) -> None:
    ...
    self._ptr.call_with_return(223,tuple([curve]))
  ...
  def set_fog_depth_begin(self, begin:'float'   ) -> None:
    ...
    self._ptr.call_with_return(225,tuple([begin]))
  ...
  def set_fog_depth_end(self, end:'float'   ) -> None:
    ...
    self._ptr.call_with_return(227,tuple([end]))
  ...
  def set_volumetric_fog_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(229,tuple([enabled]))
  ...
  def set_volumetric_fog_emission(self, color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(231,tuple([color._ptr]))
  ...
  def set_volumetric_fog_albedo(self, color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(233,tuple([color._ptr]))
  ...
  def set_volumetric_fog_density(self, density:'float'   ) -> None:
    ...
    self._ptr.call_with_return(235,tuple([density]))
  ...
  def set_volumetric_fog_emission_energy(self, begin:'float'   ) -> None:
    ...
    self._ptr.call_with_return(237,tuple([begin]))
  ...
  def set_volumetric_fog_anisotropy(self, anisotropy:'float'   ) -> None:
    ...
    self._ptr.call_with_return(239,tuple([anisotropy]))
  ...
  def set_volumetric_fog_length(self, length:'float'   ) -> None:
    ...
    self._ptr.call_with_return(241,tuple([length]))
  ...
  def set_volumetric_fog_detail_spread(self, detail_spread:'float'   ) -> None:
    ...
    self._ptr.call_with_return(243,tuple([detail_spread]))
  ...
  def set_volumetric_fog_gi_inject(self, gi_inject:'float'   ) -> None:
    ...
    self._ptr.call_with_return(245,tuple([gi_inject]))
  ...
  def set_volumetric_fog_sky_affect(self, sky_affect:'float'   ) -> None:
    ...
    self._ptr.call_with_return(249,tuple([sky_affect]))
  ...
  def set_volumetric_fog_temporal_reprojection_amount(self, temporal_reprojection_amount:'float'   ) -> None:
    ...
    self._ptr.call_with_return(253,tuple([temporal_reprojection_amount]))
  ...
  def set_adjustment_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(255,tuple([enabled]))
  ...
  def set_adjustment_brightness(self, brightness:'float'   ) -> None:
    ...
    self._ptr.call_with_return(257,tuple([brightness]))
  ...
  def set_adjustment_contrast(self, contrast:'float'   ) -> None:
    ...
    self._ptr.call_with_return(259,tuple([contrast]))
  ...
  def set_adjustment_saturation(self, saturation:'float'   ) -> None:
    ...
    self._ptr.call_with_return(261,tuple([saturation]))
  ...
  def set_adjustment_color_correction(self, color_correction:'py4godot_texture.Texture'   ) -> None:
    ...
    self._ptr.call_with_return(263,tuple([color_correction._ptr]))
