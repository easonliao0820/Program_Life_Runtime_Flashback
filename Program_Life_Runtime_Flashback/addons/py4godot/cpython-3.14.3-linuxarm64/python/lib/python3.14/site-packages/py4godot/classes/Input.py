...
class Input(py4godot_object.Object):
  ...
  def instance():
    ...
    if _Input_singleton_instance is None:
      singleton = Input()
      singleton._ptr = constructor(947,0, ())
  ...
  @functools.native_method
  def set_joy_light(self, device:'int'   , color:'Color'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(86,tuple([device, color._ptr]))

  @functools.native_method
  def has_joy_light(self, device:'int'   ) -> typing.Union[bool]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(87,tuple([device]))
    return _ret
  ...
  def set_mouse_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(91,tuple([mode]))
  ...
  def warp_mouse(self, position:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(93,tuple([position._ptr]))
  ...
  def action_press(self, action:'object'   , strength:'float' =1.0  ) -> None:
    ...
    self._ptr.call_with_return(94,tuple([py_stringname_action._ptr, strength]))
  ...
  def action_release(self, action:'object'   ) -> None:
    ...
    self._ptr.call_with_return(95,tuple([py_stringname_action._ptr]))
  ...
  def set_default_cursor_shape(self, shape:'int'  =0) -> None:
    ...
    self._ptr.call_with_return(96,tuple([shape]))
  ...
  def set_custom_mouse_cursor(self, image:'py4godot_resource.Resource'   , shape:'int'  =0, hotspot:'Vector2' = None  ) -> None:
    ...
    self._ptr.call_with_return(98,tuple([image._ptr, shape, hotspot._ptr]))
  ...
  def parse_input_event(self, event:'py4godot_inputevent.InputEvent'   ) -> None:
    ...
    self._ptr.call_with_return(99,tuple([event._ptr]))
