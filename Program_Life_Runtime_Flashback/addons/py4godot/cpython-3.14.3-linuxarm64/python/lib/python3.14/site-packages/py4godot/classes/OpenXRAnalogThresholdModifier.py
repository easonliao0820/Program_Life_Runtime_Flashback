...
class OpenXRAnalogThresholdModifier(py4godot_openxractionbindingmodifier.OpenXRActionBindingModifier):
  ...
  @property
  def on_haptic(self) -> typing.Union['py4godot_openxrhapticvibration.OpenXRHapticVibration','py4godot_openxrhapticbase.OpenXRHapticBase']:
    r''''''
  ...
  @property
  def off_haptic(self) -> typing.Union['py4godot_openxrhapticvibration.OpenXRHapticVibration','py4godot_openxrhapticbase.OpenXRHapticBase']:
    r''''''
  ...
  @functools.native_method
  def get_on_haptic(self) -> typing.Union['py4godot_openxrhapticvibration.OpenXRHapticVibration','py4godot_openxrhapticbase.OpenXRHapticBase']:
    r''''''
  ...
  @functools.native_method
  def get_off_haptic(self) -> typing.Union['py4godot_openxrhapticvibration.OpenXRHapticVibration','py4godot_openxrhapticbase.OpenXRHapticBase']:
    r''''''
