...
class ThemeDB(py4godot_object.Object):
  ...
  def instance():
    ...
    if _ThemeDB_singleton_instance is None:
      singleton = ThemeDB()
      singleton._ptr = constructor(752,0, ())
  ...
  @property
  def fallback_font(self) -> typing.Union['py4godot_fontfile.FontFile','py4godot_fontvariation.FontVariation','py4godot_font.Font','py4godot_systemfont.SystemFont']:
    r''''''
  ...
  @property
  def fallback_stylebox(self) -> typing.Union['py4godot_stylebox.StyleBox','py4godot_styleboxtexture.StyleBoxTexture','py4godot_styleboxflat.StyleBoxFlat','py4godot_styleboxempty.StyleBoxEmpty','py4godot_styleboxline.StyleBoxLine']:
    r''''''
  ...
  @functools.native_method
  def get_fallback_font(self) -> typing.Union['py4godot_fontfile.FontFile','py4godot_fontvariation.FontVariation','py4godot_font.Font','py4godot_systemfont.SystemFont']:
    r''''''
  ...
  @functools.native_method
  def get_fallback_stylebox(self) -> typing.Union['py4godot_stylebox.StyleBox','py4godot_styleboxtexture.StyleBoxTexture','py4godot_styleboxflat.StyleBoxFlat','py4godot_styleboxempty.StyleBoxEmpty','py4godot_styleboxline.StyleBoxLine']:
    r''''''
