...
class EditorInspector(py4godot_scrollcontainer.ScrollContainer):
  ...
  def edit(self, object_:'py4godot_object.Object'   ) -> None:
    ...
    self._ptr.call_with_return(467,tuple([object_._ptr]))
  ...
  def instantiate_property_editor(object_:'py4godot_object.Object'   , type:'int'  , path:'str'   , hint:'int'  , hint_text:'str'   , usage:'int'   , wide:'bool' =False  ) -> typing.Union['py4godot_editorproperty.EditorProperty']:
    ...
    _ret._ptr = static_method(636,2,tuple([object_._ptr, type, py_string_path._ptr, hint, py_string_hint_text._ptr, usage, wide]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
