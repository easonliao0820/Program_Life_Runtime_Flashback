...
class OpenXRCompositionLayer(py4godot_node3d.Node3D):
  ...
  @property
  def protected_content(self) -> typing.Union[bool]:
    r''''''
    _ret = self. is_protected_content()
    return _ret
  @protected_content.setter
  def protected_content(self,  value:'bool'):
    self.set_protected_content(value)
  @property
  ...
  @functools.native_method
  def is_protected_content(self) -> typing.Union[bool]:
    r''''''
  ...
  @functools.native_method
  def set_protected_content(self, protected_content:'bool'   ) -> None:
    r''''''

    assert isinstance(protected_content, bool), 'protected_content must be bool'


    self.py__protected_content = protected_content
    ...
    self._ptr.call_with_return(266,tuple([protected_content]))
  ...
  def set_alpha_swizzle(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(283,tuple([mode]))
  ...
  def set_max_anisotropy(self, value:'float'   ) -> None:
    ...
    self._ptr.call_with_return(285,tuple([value]))
  ...
  def set_border_color(self, color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(287,tuple([color._ptr]))
  ...
  def intersects_ray(self, origin:'Vector3'   , direction:'Vector3'   ) -> typing.Union['Vector2']:
    ...
    _ret._ptr = self._ptr.call_with_return(289,tuple([origin._ptr, direction._ptr]))
    return _ret
