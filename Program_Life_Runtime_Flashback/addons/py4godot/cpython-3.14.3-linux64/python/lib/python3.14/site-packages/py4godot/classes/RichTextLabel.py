...
class RichTextLabel(py4godot_control.Control):
  ...
  def add_text(self, text:'str'   ) -> None:
    ...
    self._ptr.call_with_return(439,tuple([py_string_text._ptr]))
  ...
  def set_text(self, text:'str'   ) -> None:
    ...
    self._ptr.call_with_return(440,tuple([py__string_text._ptr]))
  ...
  def add_hr(self, width:'int' =90  , height:'int' =2  , color:'Color' = None  , alignment:'int'  =1, width_in_percent:'bool' =True  , height_in_percent:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(441,tuple([width, height, color._ptr, alignment, width_in_percent, height_in_percent]))
  ...
  def add_image(self, image:'py4godot_texture2d.Texture2D'   , width:'int' =0  , height:'int' =0  , color:'Color' = None  , inline_align:'int'  =5, region:'Rect2' = None  , key:'object' =None  , pad:'bool' =False  , tooltip:'str' =""  , width_in_percent:'bool' =False  , height_in_percent:'bool' =False  , alt_text:'str' =""  ) -> None:
    ...
    self._ptr.call_with_return(442,tuple([image._ptr, width, height, color._ptr, inline_align, region._ptr, key, pad, py_string_tooltip._ptr, width_in_percent, height_in_percent, py_string_alt_text._ptr]))
  ...
  def update_image(self, key:'object'   , mask:'int'   , image:'py4godot_texture2d.Texture2D'   , width:'int' =0  , height:'int' =0  , color:'Color' = None  , inline_align:'int'  =5, region:'Rect2' = None  , pad:'bool' =False  , tooltip:'str' =""  , width_in_percent:'bool' =False  , height_in_percent:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(443,tuple([key, mask, image._ptr, width, height, color._ptr, inline_align, region._ptr, pad, py_string_tooltip._ptr, width_in_percent, height_in_percent]))
  ...
  def remove_paragraph(self, paragraph:'int'   , no_invalidate:'bool' =False  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(445,tuple([paragraph, no_invalidate]))
    return _ret
  ...
  def invalidate_paragraph(self, paragraph:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(446,tuple([paragraph]))
    return _ret
  ...
  def push_font(self, font:'py4godot_font.Font'   , font_size:'int' =0  ) -> None:
    ...
    self._ptr.call_with_return(447,tuple([font._ptr, font_size]))
  ...
  def push_font_size(self, font_size:'int'   ) -> None:
    ...
    self._ptr.call_with_return(448,tuple([font_size]))
  ...
  def push_normal(self) -> None:
    ...
    self._ptr.call_with_return(449,tuple([]))
  ...
  def push_bold(self) -> None:
    ...
    self._ptr.call_with_return(450,tuple([]))
  ...
  def push_bold_italics(self) -> None:
    ...
    self._ptr.call_with_return(451,tuple([]))
  ...
  def push_italics(self) -> None:
    ...
    self._ptr.call_with_return(452,tuple([]))
  ...
  def push_color(self, color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(454,tuple([color._ptr]))
  ...
  def push_outline_size(self, outline_size:'int'   ) -> None:
    ...
    self._ptr.call_with_return(455,tuple([outline_size]))
  ...
  def push_outline_color(self, color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(456,tuple([color._ptr]))
  ...
  def push_paragraph(self, alignment:'int'  , base_direction:'int'  =0, language:'str' =""  , st_parser:'int'  =0, justification_flags:'int' =163  , tab_stops:'PackedFloat32Array' = None  ) -> None:
    ...
    self._ptr.call_with_return(457,tuple([alignment, base_direction, py_string_language._ptr, st_parser, justification_flags, tab_stops._ptr]))
  ...
  def push_indent(self, level:'int'   ) -> None:
    ...
    self._ptr.call_with_return(458,tuple([level]))
  ...
  def push_list(self, level:'int'   , type:'int'  , capitalize:'bool'   , bullet:'str' ="•"  ) -> None:
    ...
    self._ptr.call_with_return(459,tuple([level, type, capitalize, py_string_bullet._ptr]))
  ...
  def push_meta(self, data:'object'   , underline_mode:'int'  =1, tooltip:'str' =""  ) -> None:
    ...
    self._ptr.call_with_return(460,tuple([data, underline_mode, py_string_tooltip._ptr]))
  ...
  def push_hint(self, description:'str'   ) -> None:
    ...
    self._ptr.call_with_return(461,tuple([py_string_description._ptr]))
  ...
  def push_language(self, language:'str'   ) -> None:
    ...
    self._ptr.call_with_return(462,tuple([py_string_language._ptr]))
  ...
  def push_underline(self, color:'Color' = None  ) -> None:
    ...
    self._ptr.call_with_return(463,tuple([color._ptr]))
  ...
  def push_table(self, columns:'int'   , inline_align:'int'  =0, align_to_row:'int' =-1  , name:'str' =""  ) -> None:
    ...
    self._ptr.call_with_return(465,tuple([columns, inline_align, align_to_row, py_string_name._ptr]))
  ...
  def push_dropcap(self, string:'str'   , font:'py4godot_font.Font'   , size:'int'   , dropcap_margins:'Rect2' = None  , color:'Color' = None  , outline_size:'int' =0  , outline_color:'Color' = None  ) -> None:
    ...
    self._ptr.call_with_return(466,tuple([py_string_string._ptr, font._ptr, size, dropcap_margins._ptr, color._ptr, outline_size, outline_color._ptr]))
  ...
  def set_table_column_expand(self, column:'int'   , expand:'bool'   , ratio:'int' =1  , shrink:'bool' =True  ) -> None:
    ...
    self._ptr.call_with_return(467,tuple([column, expand, ratio, shrink]))
  ...
  def set_table_column_name(self, column:'int'   , name:'str'   ) -> None:
    ...
    self._ptr.call_with_return(468,tuple([column, py_string_name._ptr]))
  ...
  def set_cell_row_background_color(self, odd_row_bg:'Color'   , even_row_bg:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(469,tuple([odd_row_bg._ptr, even_row_bg._ptr]))
  ...
  def set_cell_border_color(self, color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(470,tuple([color._ptr]))
  ...
  def set_cell_size_override(self, min_size:'Vector2'   , max_size:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(471,tuple([min_size._ptr, max_size._ptr]))
  ...
  def set_cell_padding(self, padding:'Rect2'   ) -> None:
    ...
    self._ptr.call_with_return(472,tuple([padding._ptr]))
  ...
  def push_fgcolor(self, fgcolor:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(474,tuple([fgcolor._ptr]))
  ...
  def push_bgcolor(self, bgcolor:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(475,tuple([bgcolor._ptr]))
  ...
  def push_customfx(self, effect:'py4godot_richtexteffect.RichTextEffect'   , env:'Dictionary'   ) -> None:
    ...
    self._ptr.call_with_return(476,tuple([effect._ptr, env._ptr]))
  ...
  def push_context(self) -> None:
    ...
    self._ptr.call_with_return(477,tuple([]))
  ...
  def pop_context(self) -> None:
    ...
    self._ptr.call_with_return(478,tuple([]))
  ...
  def pop(self) -> None:
    ...
    self._ptr.call_with_return(479,tuple([]))
  ...
  def pop_all(self) -> None:
    ...
    self._ptr.call_with_return(480,tuple([]))
  ...
  def set_structured_text_bidi_override(self, parser:'int'  ) -> None:
    ...
    self._ptr.call_with_return(482,tuple([parser]))
  ...
  def set_structured_text_bidi_override_options(self, args:'Array'   ) -> None:
    ...
    self._ptr.call_with_return(484,tuple([args._ptr]))
  ...
  def set_text_direction(self, direction:'int'  ) -> None:
    ...
    self._ptr.call_with_return(486,tuple([direction]))
  ...
  def set_language(self, language:'str'   ) -> None:
    ...
    self._ptr.call_with_return(488,tuple([py__string_language._ptr]))
  ...
  def get_language(self) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(489,tuple([]))
  ...
  def set_horizontal_alignment(self, alignment:'int'  ) -> None:
    ...
    self._ptr.call_with_return(490,tuple([alignment]))
  ...
  def set_vertical_alignment(self, alignment:'int'  ) -> None:
    ...
    self._ptr.call_with_return(492,tuple([alignment]))
  ...
  def set_justification_flags(self, justification_flags:'int'   ) -> None:
    ...
    self._ptr.call_with_return(494,tuple([justification_flags]))
  ...
  def set_tab_stops(self, tab_stops:'PackedFloat32Array'   ) -> None:
    ...
    self._ptr.call_with_return(496,tuple([tab_stops._ptr]))
  ...
  def get_tab_stops(self) -> typing.Union['PackedFloat32Array']:
    ...
    _ret._ptr = self._ptr.call_with_return(497,tuple([]))
  ...
  def set_autowrap_mode(self, autowrap_mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(498,tuple([autowrap_mode]))
  ...
  def set_autowrap_trim_flags(self, autowrap_trim_flags:'int'   ) -> None:
    ...
    self._ptr.call_with_return(500,tuple([autowrap_trim_flags]))
  ...
  def set_hint_underline(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(504,tuple([enable]))
  ...
  def set_scroll_active(self, active:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(506,tuple([active]))
  ...
  def set_scroll_follow_visible_characters(self, follow:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(508,tuple([follow]))
  ...
  def set_scroll_follow(self, follow:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(510,tuple([follow]))
  ...
  def get_v_scroll_bar(self) -> typing.Union['py4godot_vscrollbar.VScrollBar']:
    ...
    _ret._ptr = self._ptr.call_with_return(512,tuple([]))
  ...
  def scroll_to_line(self, line:'int'   ) -> None:
    ...
    self._ptr.call_with_return(513,tuple([line]))
  ...
  def scroll_to_paragraph(self, paragraph:'int'   ) -> None:
    ...
    self._ptr.call_with_return(514,tuple([paragraph]))
  ...
  def set_tab_size(self, spaces:'int'   ) -> None:
    ...
    self._ptr.call_with_return(516,tuple([spaces]))
  ...
  def set_fit_content(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(518,tuple([enabled]))
  ...
  def set_selection_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(520,tuple([enabled]))
  ...
  def is_selection_enabled(self) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(521,tuple([]))
  ...
  def set_deselect_on_focus_loss_enabled(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(526,tuple([enable]))
  ...
  def set_drag_and_drop_selection_enabled(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(528,tuple([enable]))
  ...
  def is_drag_and_drop_selection_enabled(self) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(529,tuple([]))
  ...
  def get_selection_to(self) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(531,tuple([]))
    return _ret
  ...
  def select_all(self) -> None:
    ...
    self._ptr.call_with_return(533,tuple([]))
  ...
  def deselect(self) -> None:
    ...
    self._ptr.call_with_return(535,tuple([]))
  ...
  def parse_bbcode(self, bbcode:'str'   ) -> None:
    ...
    self._ptr.call_with_return(536,tuple([py_string_bbcode._ptr]))
  ...
  def append_text(self, bbcode:'str'   ) -> None:
    ...
    self._ptr.call_with_return(537,tuple([py_string_bbcode._ptr]))
  ...
  def get_text(self) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(538,tuple([]))
  ...
  def set_threaded(self, threaded:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(541,tuple([threaded]))
  ...
  def set_progress_bar_delay(self, delay_ms:'int'   ) -> None:
    ...
    self._ptr.call_with_return(543,tuple([delay_ms]))
  ...
  def set_visible_characters(self, amount:'int'   ) -> None:
    ...
    self._ptr.call_with_return(545,tuple([amount]))
  ...
  def set_visible_characters_behavior(self, behavior:'int'  ) -> None:
    ...
    self._ptr.call_with_return(548,tuple([behavior]))
  ...
  def set_visible_ratio(self, ratio:'float'   ) -> None:
    ...
    self._ptr.call_with_return(549,tuple([ratio]))
  ...
  def get_character_line(self, character:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(551,tuple([character]))
    return _ret
  ...
  def get_character_paragraph(self, character:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(552,tuple([character]))
    return _ret
  ...
  def set_use_bbcode(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(554,tuple([enable]))
  ...
  def get_line_range(self, line:'int'   ) -> typing.Union['Vector2i']:
    ...
    _ret._ptr = self._ptr.call_with_return(557,tuple([line]))
    return _ret
  ...
  def get_visible_line_count(self) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(558,tuple([]))
    return _ret
  ...
  def get_visible_paragraph_count(self) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(560,tuple([]))
    return _ret
  ...
  def get_content_width(self) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(562,tuple([]))
    return _ret
  ...
  def get_line_height(self, line:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(563,tuple([line]))
    return _ret
  ...
  def get_line_width(self, line:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(564,tuple([line]))
    return _ret
  ...
  def get_line_offset(self, line:'int'   ) -> typing.Union[float]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(566,tuple([line]))
    return _ret
  ...
  def get_paragraph_offset(self, paragraph:'int'   ) -> typing.Union[float]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(567,tuple([paragraph]))
    return _ret
  ...
  def parse_expressions_for_values(self, expressions:'PackedStringArray'   ) -> typing.Union['Dictionary']:
    ...
    _ret._ptr = self._ptr.call_with_return(568,tuple([expressions._ptr]))
    return _ret
  ...
  def set_effects(self, effects:'Array'   ) -> None:
    ...
    self._ptr.call_with_return(569,tuple([effects._ptr]))
  ...
  def install_effect(self, effect:'object'   ) -> None:
    ...
    self._ptr.call_with_return(571,tuple([effect]))
  ...
  def reload_effects(self) -> None:
    ...
    self._ptr.call_with_return(572,tuple([]))
  ...
  def menu_option(self, option:'int'   ) -> None:
    ...
    self._ptr.call_with_return(575,tuple([option]))
