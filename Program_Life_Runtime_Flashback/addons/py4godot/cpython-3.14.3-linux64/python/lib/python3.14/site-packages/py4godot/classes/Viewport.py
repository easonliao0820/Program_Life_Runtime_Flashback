...
class Viewport(py4godot_node.Node):
  ...
  @property
  def gui_drag_threshold(self) -> typing.Union[int]:
    r''''''
    _ret = self. get_drag_threshold()
    return _ret
  @gui_drag_threshold.setter
  def gui_drag_threshold(self,  value:'int'):
    self.set_drag_threshold(value)
  @property
  ...
  def positional_shadow_atlas_quad_0(self,  value:'int'):
    self.set_positional_shadow_atlas_quadrant_subdiv(0, value)
  @property
  ...
  def positional_shadow_atlas_quad_1(self,  value:'int'):
    self.set_positional_shadow_atlas_quadrant_subdiv(1, value)
  @property
  ...
  def positional_shadow_atlas_quad_2(self,  value:'int'):
    self.set_positional_shadow_atlas_quadrant_subdiv(2, value)
  @property
  ...
  def positional_shadow_atlas_quad_3(self,  value:'int'):
    self.set_positional_shadow_atlas_quadrant_subdiv(3, value)
  @property
  ...
  def set_drag_threshold(self, threshold:'int'   ) -> None:
    ...
    self.py__gui_drag_threshold = threshold
    ...
    self._ptr.call_with_return(263,tuple([threshold]))

  @functools.native_method
  def get_drag_threshold(self) -> typing.Union[int]:
    r''''''
  ...
  def set_canvas_cull_mask(self, mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(265,tuple([mask]))
  ...
  def set_canvas_cull_mask_bit(self, layer:'int'   , enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(267,tuple([layer, enable]))
  ...
  def get_canvas_cull_mask_bit(self, layer:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(268,tuple([layer]))
    return _ret
  ...
  def set_sdf_oversize(self, oversize:'int'  ) -> None:
    ...
    self._ptr.call_with_return(271,tuple([oversize]))
  ...
  def set_sdf_scale(self, scale:'int'  ) -> None:
    ...
    self._ptr.call_with_return(273,tuple([scale]))
  ...
  def set_mesh_lod_threshold(self, pixels:'float'   ) -> None:
    ...
    self._ptr.call_with_return(275,tuple([pixels]))
  ...
  def set_as_audio_listener_2d(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(277,tuple([enable]))
  ...
  def set_world_3d(self, world_3d:'py4godot_world3d.World3D'   ) -> None:
    ...
    self._ptr.call_with_return(281,tuple([world_3d._ptr]))
  ...
  def set_disable_3d(self, disable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(290,tuple([disable]))
  ...
  def set_use_xr(self, use:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(292,tuple([use]))
  ...
  def set_scaling_3d_mode(self, scaling_3d_mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(294,tuple([scaling_3d_mode]))
  ...
  def set_scaling_3d_scale(self, scale:'float'   ) -> None:
    ...
    self._ptr.call_with_return(296,tuple([scale]))
  ...
  def set_fsr_sharpness(self, fsr_sharpness:'float'   ) -> None:
    ...
    self._ptr.call_with_return(298,tuple([fsr_sharpness]))
  ...
  def set_texture_mipmap_bias(self, texture_mipmap_bias:'float'   ) -> None:
    ...
    self._ptr.call_with_return(300,tuple([texture_mipmap_bias]))
  ...
  def set_anisotropic_filtering_level(self, anisotropic_filtering_level:'int'  ) -> None:
    ...
    self._ptr.call_with_return(302,tuple([anisotropic_filtering_level]))
  ...
  def set_vrs_update_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(306,tuple([mode]))
  ...
  def set_vrs_texture(self, texture:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(308,tuple([texture._ptr]))
