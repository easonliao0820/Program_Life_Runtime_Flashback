...
class Tween(py4godot_refcounted.RefCounted):
  r'''
		...
		A tween animation is created by adding `Tweener`s to the `Tween` object, using `tween_property`, `tween_interval`, `tween_callback`, `tween_method`, `tween_subtween`, or `tween_await`:
  ...
  def interpolate_value(initial_value:'object'   , delta_value:'object'   , elapsed_time:'float'   , duration:'float'   , trans_type:'int'  , ease_type:'int'  ) -> typing.Union[typing.Any]:
    ...
    _ret = None
    _ret = static_method(74,0,tuple([initial_value, delta_value, elapsed_time, duration, trans_type, ease_type]))
    return _ret
