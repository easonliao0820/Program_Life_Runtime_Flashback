...
class EditorSettings(py4godot_resource.Resource):
  ...
  def init_signals(self):
    ...
    _favorites_changed_name = utils.py_string_to_string_name("_favorites_changed")
    self._favorites_changed = signals.BuiltinSignal(self, _favorites_changed_name)
  ...
  @functools.native_method
  def add_shortcut(self, path:'str'   , shortcut:'py4godot_shortcut.Shortcut'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(90,tuple([py_string_path._ptr, shortcut._ptr]))
  ...
  def remove_shortcut(self, path:'str'   ) -> None:
    ...
    self._ptr.call_with_return(91,tuple([py_string_path._ptr]))

  @functools.native_method
  def is_shortcut(self, path:'str'   , event:'py4godot_inputevent.InputEvent'   ) -> typing.Union[bool]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(92,tuple([py_string_path._ptr, event._ptr]))
    return _ret


  @functools.native_method
  def has_shortcut(self, path:'str'   ) -> typing.Union[bool]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(93,tuple([py_string_path._ptr]))
    return _ret


  @functools.native_method
  def get_shortcut(self, path:'str'   ) -> typing.Union['py4godot_shortcut.Shortcut']:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(94,tuple([py_string_path._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def get_shortcut_list(self) -> typing.Union['PackedStringArray']:
    r'''
  ...
  def check_changed_settings_in_group(self, setting_prefix:'str'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(96,tuple([py_string_setting_prefix._ptr]))
    return _ret
  ...
  def mark_setting_changed(self, setting:'str'   ) -> None:
    ...
    self._ptr.call_with_return(98,tuple([py_string_setting._ptr]))
