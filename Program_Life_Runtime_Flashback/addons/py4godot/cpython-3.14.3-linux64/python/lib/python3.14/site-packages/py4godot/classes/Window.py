...
class Window(py4godot_viewport.Viewport):
  ...
  def init_signals(self):
    ...
    nonclient_window_input_name = utils.py_string_to_string_name("nonclient_window_input")
    self.nonclient_window_input = signals.BuiltinSignal(self, nonclient_window_input_name)
  ...
  @property
  def nonclient_area(self) -> typing.Union['Rect2i']:
    r''''''
    _ret = self. get_nonclient_area()
    return _ret
  @nonclient_area.setter
  def nonclient_area(self,  value:'Rect2i'):
    self.set_nonclient_area(value)
  @property
  ...
  def set_title(self, title:'str'   ) -> None:
    ...
    self._ptr.call_with_return(311,tuple([py__string_title._ptr]))
  ...
  def set_initial_position(self, initial_position:'int'  ) -> None:
    ...
    self._ptr.call_with_return(313,tuple([initial_position]))
  ...
  def set_current_screen(self, index:'int'   ) -> None:
    ...
    self._ptr.call_with_return(315,tuple([index]))
  ...
  def set_position(self, position:'Vector2i'   ) -> None:
    ...
    self._ptr.call_with_return(317,tuple([position._ptr]))
  ...
  def move_to_center(self) -> None:
    ...
    self._ptr.call_with_return(319,tuple([]))
  ...
  def set_size(self, size:'Vector2i'   ) -> None:
    ...
    self._ptr.call_with_return(320,tuple([size._ptr]))
  ...
  def reset_size(self) -> None:
    ...
    self._ptr.call_with_return(322,tuple([]))
  ...
  def set_max_size(self, max_size:'Vector2i'   ) -> None:
    ...
    self._ptr.call_with_return(325,tuple([max_size._ptr]))
  ...
  def set_min_size(self, min_size:'Vector2i'   ) -> None:
    ...
    self._ptr.call_with_return(327,tuple([min_size._ptr]))
  ...
  def set_flag(self, flag:'int'  , enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(331,tuple([flag, enabled]))
  ...
  def get_flag(self, flag:'int'  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(332,tuple([flag]))
  ...
  def move_to_foreground(self) -> None:
    ...
    self._ptr.call_with_return(335,tuple([]))
  ...
  def set_visible(self, visible:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(336,tuple([visible]))
  ...
  def set_transient(self, transient:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(340,tuple([transient]))
  ...
  def set_exclusive(self, exclusive:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(344,tuple([exclusive]))
  ...
  def set_unparent_when_invisible(self, unparent:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(346,tuple([unparent]))
  ...
  def start_drag(self) -> None:
    ...
    self._ptr.call_with_return(350,tuple([]))
  ...
  def start_resize(self, edge:'int'  ) -> None:
    ...
    self._ptr.call_with_return(351,tuple([edge]))
  ...
  def set_ime_active(self, active:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(352,tuple([active]))
  ...
  def set_ime_position(self, position:'Vector2i'   ) -> None:
    ...
    self._ptr.call_with_return(353,tuple([position._ptr]))
  ...
  def get_contents_minimum_size(self) -> typing.Union['Vector2']:
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(355,tuple([]))
    return _ret
  ...
  def set_force_native(self, force_native:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(356,tuple([force_native]))
  ...
  def set_content_scale_size(self, size:'Vector2i'   ) -> None:
    ...
    self._ptr.call_with_return(358,tuple([size._ptr]))
  ...
  def get_content_scale_size(self) -> typing.Union['Vector2i']:
    ...
    _ret = Vector2i.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(359,tuple([]))
  ...
  def set_content_scale_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(360,tuple([mode]))
  ...
  def set_content_scale_aspect(self, aspect:'int'  ) -> None:
    ...
    self._ptr.call_with_return(362,tuple([aspect]))
  ...
  def set_content_scale_stretch(self, stretch:'int'  ) -> None:
    ...
    self._ptr.call_with_return(364,tuple([stretch]))
  ...
  @functools.native_method
  def set_nonclient_area(self, area:'Rect2i'   ) -> None:
    r''''''

    assert(not area is None)
    assert isinstance(area, Rect2i), 'area must be Rect2i'


    self.py__nonclient_area = area
    ...
    self._ptr.call_with_return(366,tuple([area._ptr]))

  @functools.native_method
  def get_nonclient_area(self) -> typing.Union['Rect2i']:
    r''''''
  ...
  def set_keep_title_visible(self, title_visible:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(368,tuple([title_visible]))
  ...
  def set_content_scale_factor(self, factor:'float'   ) -> None:
    ...
    self._ptr.call_with_return(370,tuple([factor]))
  ...
  def set_mouse_passthrough_polygon(self, polygon:'PackedVector2Array'   ) -> None:
    ...
    self._ptr.call_with_return(372,tuple([polygon._ptr]))
  ...
  def set_wrap_controls(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(374,tuple([enable]))
  ...
  def child_controls_changed(self) -> None:
    ...
    self._ptr.call_with_return(376,tuple([]))
  ...
  def set_theme(self, theme:'py4godot_theme.Theme'   ) -> None:
    ...
    self._ptr.call_with_return(377,tuple([theme._ptr]))
  ...
  def set_theme_type_variation(self, theme_type:'object'   ) -> None:
    ...
    self._ptr.call_with_return(379,tuple([py_stringname_theme_type._ptr]))
  ...
  def get_theme_type_variation(self) -> typing.Union['StringName']:
    ...
    _ret._ptr = self._ptr.call_with_return(380,tuple([]))
  ...
  def begin_bulk_theme_override(self) -> None:
    ...
    self._ptr.call_with_return(381,tuple([]))
  ...
  def end_bulk_theme_override(self) -> None:
    ...
    self._ptr.call_with_return(382,tuple([]))
  ...
  def add_theme_icon_override(self, name:'object'   , texture:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(383,tuple([py_stringname_name._ptr, texture._ptr]))
  ...
  def add_theme_stylebox_override(self, name:'object'   , stylebox:'py4godot_stylebox.StyleBox'   ) -> None:
    ...
    self._ptr.call_with_return(384,tuple([py_stringname_name._ptr, stylebox._ptr]))
  ...
  def add_theme_font_override(self, name:'object'   , font:'py4godot_font.Font'   ) -> None:
    ...
    self._ptr.call_with_return(385,tuple([py_stringname_name._ptr, font._ptr]))
  ...
  def add_theme_font_size_override(self, name:'object'   , font_size:'int'   ) -> None:
    ...
    self._ptr.call_with_return(386,tuple([py_stringname_name._ptr, font_size]))
  ...
  def add_theme_color_override(self, name:'object'   , color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(387,tuple([py_stringname_name._ptr, color._ptr]))
  ...
  def add_theme_constant_override(self, name:'object'   , constant:'int'   ) -> None:
    ...
    self._ptr.call_with_return(388,tuple([py_stringname_name._ptr, constant]))
  ...
  def remove_theme_font_override(self, name:'object'   ) -> None:
    ...
    self._ptr.call_with_return(391,tuple([py_stringname_name._ptr]))
  ...
  def remove_theme_font_size_override(self, name:'object'   ) -> None:
    ...
    self._ptr.call_with_return(392,tuple([py_stringname_name._ptr]))
  ...
  def remove_theme_color_override(self, name:'object'   ) -> None:
    ...
    self._ptr.call_with_return(393,tuple([py_stringname_name._ptr]))
  ...
  def remove_theme_constant_override(self, name:'object'   ) -> None:
    ...
    self._ptr.call_with_return(394,tuple([py_stringname_name._ptr]))
  ...
  def get_theme_stylebox(self, name:'object'   , theme_type:'object' = None  ) -> typing.Union['py4godot_stylebox.StyleBox','py4godot_styleboxtexture.StyleBoxTexture','py4godot_styleboxflat.StyleBoxFlat','py4godot_styleboxempty.StyleBoxEmpty','py4godot_styleboxline.StyleBoxLine']:
    ...
    _ret._ptr = self._ptr.call_with_return(396,tuple([py_stringname_name._ptr, py_stringname_theme_type._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def get_theme_font(self, name:'object'   , theme_type:'object' = None  ) -> typing.Union['py4godot_fontfile.FontFile','py4godot_fontvariation.FontVariation','py4godot_font.Font','py4godot_systemfont.SystemFont']:
    ...
    _ret._ptr = self._ptr.call_with_return(397,tuple([py_stringname_name._ptr, py_stringname_theme_type._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def get_theme_font_size(self, name:'object'   , theme_type:'object' = None  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(398,tuple([py_stringname_name._ptr, py_stringname_theme_type._ptr]))
    return _ret
  ...
  def get_theme_color(self, name:'object'   , theme_type:'object' = None  ) -> typing.Union['Color']:
    ...
    _ret._ptr = self._ptr.call_with_return(399,tuple([py_stringname_name._ptr, py_stringname_theme_type._ptr]))
    return _ret
  ...
  def get_theme_constant(self, name:'object'   , theme_type:'object' = None  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(400,tuple([py_stringname_name._ptr, py_stringname_theme_type._ptr]))
    return _ret
  ...
  def has_theme_font_override(self, name:'object'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(403,tuple([py_stringname_name._ptr]))
    return _ret
  ...
  def has_theme_font_size_override(self, name:'object'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(404,tuple([py_stringname_name._ptr]))
    return _ret
  ...
  def has_theme_color_override(self, name:'object'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(405,tuple([py_stringname_name._ptr]))
    return _ret
  ...
  def has_theme_constant_override(self, name:'object'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(406,tuple([py_stringname_name._ptr]))
    return _ret
  ...
  def has_theme_font(self, name:'object'   , theme_type:'object' = None  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(409,tuple([py_stringname_name._ptr, py_stringname_theme_type._ptr]))
    return _ret
  ...
  def has_theme_font_size(self, name:'object'   , theme_type:'object' = None  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(410,tuple([py_stringname_name._ptr, py_stringname_theme_type._ptr]))
    return _ret
  ...
  def has_theme_color(self, name:'object'   , theme_type:'object' = None  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(411,tuple([py_stringname_name._ptr, py_stringname_theme_type._ptr]))
    return _ret
  ...
  def has_theme_constant(self, name:'object'   , theme_type:'object' = None  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(412,tuple([py_stringname_name._ptr, py_stringname_theme_type._ptr]))
    return _ret
  ...
  def set_accessibility_name(self, name:'str'   ) -> None:
    ...
    self._ptr.call_with_return(417,tuple([py__string_name._ptr]))
  ...
  def get_accessibility_name(self) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(418,tuple([]))
  ...
  def set_accessibility_description(self, description:'str'   ) -> None:
    ...
    self._ptr.call_with_return(419,tuple([py__string_description._ptr]))
  ...
  def get_accessibility_description(self) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(420,tuple([]))
  ...
  def get_focused_window() -> typing.Any:
    ...
    _ret._ptr = static_method(878,2,tuple([]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def set_layout_direction(self, direction:'int'  ) -> None:
    ...
    self._ptr.call_with_return(421,tuple([direction]))
  ...
  def set_auto_translate(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(424,tuple([enable]))
  ...
  def is_auto_translating(self) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(425,tuple([]))
  ...
  def set_use_font_oversampling(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(426,tuple([enable]))
  ...
  def popup(self, rect:'Rect2i' = None  ) -> None:
    ...
    self._ptr.call_with_return(428,tuple([rect._ptr]))
  ...
  def popup_on_parent(self, parent_rect:'Rect2i'   ) -> None:
    ...
    self._ptr.call_with_return(429,tuple([parent_rect._ptr]))
  ...
  def popup_centered(self, minsize:'Vector2i' = None  ) -> None:
    ...
    self._ptr.call_with_return(430,tuple([minsize._ptr]))
  ...
  def popup_centered_ratio(self, ratio:'float' =0.8  ) -> None:
    ...
    self._ptr.call_with_return(431,tuple([ratio]))
  ...
  def popup_centered_clamped(self, minsize:'Vector2i' = None  , fallback_ratio:'float' =0.75  ) -> None:
    ...
    self._ptr.call_with_return(432,tuple([minsize._ptr, fallback_ratio]))
  ...
  def popup_exclusive(self, from_node:'py4godot_node.Node'   , rect:'Rect2i' = None  ) -> None:
    ...
    self._ptr.call_with_return(433,tuple([from_node._ptr, rect._ptr]))
  ...
  def popup_exclusive_on_parent(self, from_node:'py4godot_node.Node'   , parent_rect:'Rect2i'   ) -> None:
    ...
    self._ptr.call_with_return(434,tuple([from_node._ptr, parent_rect._ptr]))
  ...
  def popup_exclusive_centered(self, from_node:'py4godot_node.Node'   , minsize:'Vector2i' = None  ) -> None:
    ...
    self._ptr.call_with_return(435,tuple([from_node._ptr, minsize._ptr]))
  ...
  def popup_exclusive_centered_ratio(self, from_node:'py4godot_node.Node'   , ratio:'float' =0.8  ) -> None:
    ...
    self._ptr.call_with_return(436,tuple([from_node._ptr, ratio]))
  ...
  def popup_exclusive_centered_clamped(self, from_node:'py4godot_node.Node'   , minsize:'Vector2i' = None  , fallback_ratio:'float' =0.75  ) -> None:
    ...
    self._ptr.call_with_return(437,tuple([from_node._ptr, minsize._ptr, fallback_ratio]))
