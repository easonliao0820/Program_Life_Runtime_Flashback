...
class Slider(py4godot_range.Range):
  ...
  def set_ticks(self, count:'int'   ) -> None:
    ...
    self._ptr.call_with_return(462,tuple([count]))
  ...
  def set_ticks_on_borders(self, ticks_on_border:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(465,tuple([ticks_on_border]))
  ...
  def set_ticks_position(self, ticks_on_border:'int'  ) -> None:
    ...
    self._ptr.call_with_return(467,tuple([ticks_on_border]))
  ...
  def set_editable(self, editable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(468,tuple([editable]))
  ...
  def set_scrollable(self, scrollable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(470,tuple([scrollable]))
