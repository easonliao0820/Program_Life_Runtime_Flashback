...
if typing.TYPE_CHECKING:
  ...
  import py4godot.classes.TranslationTypedArray as py4godot_translationtypedarray 
...
class TranslationServer(py4godot_object.Object):
  ...
  def instance():
    ...
    if _TranslationServer_singleton_instance is None:
      ...
      singleton._ptr = constructor(888,0, ())
  ...
  @functools.native_method
  def get_plural_rules(self, locale:'str'   ) -> typing.Union[str]:
    r'''
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(61,tuple([py_string_locale._ptr]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def translate(self, message:'object'   , context:'object' = None  ) -> typing.Union['StringName']:
    ...
    _ret._ptr = self._ptr.call_with_return(62,tuple([py_stringname_message._ptr, py_stringname_context._ptr]))
    return str(_ret)
  ...
  def translate_plural(self, message:'object'   , plural_message:'object'   , n:'int'   , context:'object' = None  ) -> typing.Union['StringName']:
    ...
    _ret = StringName.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(63,tuple([py_stringname_message._ptr, py_stringname_plural_message._ptr, n, py_stringname_context._ptr]))
    return str(_ret)
  ...
  def remove_translation(self, translation:'py4godot_translation.Translation'   ) -> None:
    ...
    self._ptr.call_with_return(65,tuple([translation._ptr]))
  ...
  def get_translation_object(self, locale:'str'   ) -> typing.Union['py4godot_optimizedtranslation.OptimizedTranslation','py4godot_translation.Translation']:
    ...
    _ret._ptr = self._ptr.call_with_return(66,tuple([py_string_locale._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None


  @functools.native_method
  def get_translations(self) -> typing.Union['py4godot_translationtypedarray.TranslationTypedArray']:
    r'''
    ...
    _ret = py4godot_translationtypedarray.TranslationTypedArray.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(67,tuple([]))
    return _ret


  @functools.native_method
  def find_translations(self, locale:'str'   , exact:'bool'   ) -> typing.Union['py4godot_translationtypedarray.TranslationTypedArray']:
    r'''
    ...
    _ret = py4godot_translationtypedarray.TranslationTypedArray.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(68,tuple([py_string_locale._ptr, exact]))
    return _ret


  @functools.native_method
  def has_translation_for_locale(self, locale:'str'   , exact:'bool'   ) -> typing.Union[bool]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(69,tuple([py_string_locale._ptr, exact]))
    return _ret


  @functools.native_method
  def has_translation(self, translation:'py4godot_translation.Translation'   ) -> typing.Union[bool]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(70,tuple([translation._ptr]))
    return _ret
  ...
  def has_domain(self, domain:'object'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(71,tuple([py_stringname_domain._ptr]))
    return _ret
  ...
  def get_or_add_domain(self, domain:'object'   ) -> typing.Union['py4godot_translationdomain.TranslationDomain']:
    ...
    _ret._ptr = self._ptr.call_with_return(72,tuple([py_stringname_domain._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def remove_domain(self, domain:'object'   ) -> None:
    ...
    self._ptr.call_with_return(73,tuple([py_stringname_domain._ptr]))
  ...
  @functools.native_method
  def format_number(self, number:'str'   , locale:'str'   ) -> typing.Union[str]:
    r'''
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(76,tuple([py_string_number._ptr, py_string_locale._ptr]))
    return utils.gd_string_to_py_string(_ret)


  @functools.native_method
  def get_percent_sign(self, locale:'str'   ) -> typing.Union[str]:
    r'''
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(77,tuple([py_string_locale._ptr]))
    return utils.gd_string_to_py_string(_ret)


  @functools.native_method
  def parse_number(self, number:'str'   , locale:'str'   ) -> typing.Union[str]:
    r'''
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(78,tuple([py_string_number._ptr, py_string_locale._ptr]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def pseudolocalize(self, message:'object'   ) -> typing.Union['StringName']:
    ...
    _ret = StringName.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(82,tuple([py_stringname_message._ptr]))
    return str(_ret)
