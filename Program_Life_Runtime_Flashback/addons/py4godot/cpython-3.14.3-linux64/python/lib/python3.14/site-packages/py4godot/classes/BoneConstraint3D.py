...
class BoneConstraint3D(py4godot_skeletonmodifier3d.SkeletonModifier3D):
  ...
  @functools.native_method
  def set_reference_type(self, index:'int'   , type:'int'  ) -> None:
    r'''
				Sets the reference target type of the setting at `index` to `type`. See also `enum ReferenceType`.
			'''
    ...
    self._ptr.call_with_return(266,tuple([index, type]))

  @functools.native_method
  def get_reference_type(self, index:'int'   ) -> typing.Union[int]:
    r'''
				Returns the reference target type of the setting at `index`. See also `enum ReferenceType`.
			'''
  ...
  def set_reference_bone_name(self, index:'int'   , bone_name:'str'   ) -> None:
    ...
    self._ptr.call_with_return(268,tuple([index, py_string_bone_name._ptr]))
  ...
  def set_reference_bone(self, index:'int'   , bone:'int'   ) -> None:
    ...
    self._ptr.call_with_return(270,tuple([index, bone]))
  ...
  @functools.native_method
  def set_reference_node(self, index:'int'   , node:'object'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(272,tuple([index, py_nodepath_node._ptr]))

  @functools.native_method
  def get_reference_node(self, index:'int'   ) -> typing.Union['NodePath']:
    r'''
  ...
  def set_setting_count(self, count:'int'   ) -> None:
    ...
    self._ptr.call_with_return(274,tuple([count]))
