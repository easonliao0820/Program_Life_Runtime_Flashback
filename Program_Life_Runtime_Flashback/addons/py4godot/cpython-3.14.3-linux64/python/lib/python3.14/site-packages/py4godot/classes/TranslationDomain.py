...
class TranslationDomain(py4godot_refcounted.RefCounted):
  ...
  def has_translation_for_locale(self, locale:'str'   , exact:'bool'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(58,tuple([py_string_locale._ptr, exact]))
    return _ret
  ...
  def has_translation(self, translation:'py4godot_translation.Translation'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(59,tuple([translation._ptr]))
    return _ret
  ...
  def find_translations(self, locale:'str'   , exact:'bool'   ) -> typing.Union['py4godot_translationtypedarray.TranslationTypedArray']:
    ...
    _ret = py4godot_translationtypedarray.TranslationTypedArray.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(60,tuple([py_string_locale._ptr, exact]))
    return _ret
  ...
  def translate_plural(self, message:'object'   , message_plural:'object'   , n:'int'   , context:'object' = None  ) -> typing.Union['StringName']:
    ...
    _ret = StringName.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(62,tuple([py_stringname_message._ptr, py_stringname_message_plural._ptr, n, py_stringname_context._ptr]))
    return str(_ret)
  ...
  def set_locale_override(self, locale:'str'   ) -> None:
    ...
    self._ptr.call_with_return(64,tuple([py_string_locale._ptr]))
  ...
  def set_pseudolocalization_prefix(self, prefix:'str'   ) -> None:
    ...
    self._ptr.call_with_return(82,tuple([py__string_prefix._ptr]))
  ...
  def set_pseudolocalization_suffix(self, suffix:'str'   ) -> None:
    ...
    self._ptr.call_with_return(84,tuple([py__string_suffix._ptr]))
  ...
  def pseudolocalize(self, message:'object'   ) -> typing.Union['StringName']:
    ...
    _ret = StringName.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(85,tuple([py_stringname_message._ptr]))
    return str(_ret)
