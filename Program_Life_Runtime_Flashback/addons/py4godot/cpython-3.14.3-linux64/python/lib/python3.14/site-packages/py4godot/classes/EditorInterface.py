...
class EditorInterface(py4godot_object.Object):
  ...
  def instance():
    ...
    if _EditorInterface_singleton_instance is None:
      ...
      singleton._ptr = constructor(965,0, ())
  ...
  @functools.native_method
  def get_editor_main_screen(self) -> typing.Union['py4godot_scripteditorbase.ScriptEditorBase','py4godot_colorpicker.ColorPicker','py4godot_vboxcontainer.VBoxContainer']:
    r'''
  ...
  @functools.native_method
  def get_editor_language(self) -> typing.Union[str]:
    r'''
  ...
  @functools.native_method
  def is_node_3d_snap_enabled(self) -> typing.Union[bool]:
    r'''
  ...
  @functools.native_method
  def get_node_3d_translate_snap(self) -> typing.Union[float]:
    r'''
  ...
  @functools.native_method
  def get_node_3d_rotate_snap(self) -> typing.Union[float]:
    r'''
  ...
  @functools.native_method
  def get_node_3d_scale_snap(self) -> typing.Union[float]:
    r'''
  ...
  def popup_dialog(self, dialog:'py4godot_window.Window'   , rect:'Rect2i' = None  ) -> None:
    ...
    self._ptr.call_with_return(77,tuple([dialog._ptr, rect._ptr]))
  ...
  def popup_dialog_centered(self, dialog:'py4godot_window.Window'   , minsize:'Vector2i' = None  ) -> None:
    ...
    self._ptr.call_with_return(78,tuple([dialog._ptr, minsize._ptr]))
  ...
  def popup_dialog_centered_ratio(self, dialog:'py4godot_window.Window'   , ratio:'float' =0.8  ) -> None:
    ...
    self._ptr.call_with_return(79,tuple([dialog._ptr, ratio]))
  ...
  def popup_dialog_centered_clamped(self, dialog:'py4godot_window.Window'   , minsize:'Vector2i' = None  , fallback_ratio:'float' =0.75  ) -> None:
    ...
    self._ptr.call_with_return(80,tuple([dialog._ptr, minsize._ptr, fallback_ratio]))
  ...
  def set_current_feature_profile(self, profile_name:'str'   ) -> None:
    ...
    self._ptr.call_with_return(82,tuple([py_string_profile_name._ptr]))
  ...
  def popup_node_selector(self, callback:'Callable'   , valid_types:'py4godot_stringnametypedarray.StringNameTypedArray' = None  , current_value:'py4godot_node.Node' = None  ) -> None:
    ...
    self._ptr.call_with_return(83,tuple([callback._ptr, valid_types._ptr, current_value._ptr]))
  ...
  def popup_property_selector(self, object_:'py4godot_object.Object'   , callback:'Callable'   , type_filter:'PackedInt32Array' = None  , current_value:'str' =""  ) -> None:
    ...
    self._ptr.call_with_return(84,tuple([object_._ptr, callback._ptr, type_filter._ptr, py_string_current_value._ptr]))
  ...
  def popup_method_selector(self, object_:'py4godot_object.Object'   , callback:'Callable'   , current_value:'str' =""  ) -> None:
    ...
    self._ptr.call_with_return(85,tuple([object_._ptr, callback._ptr, py_string_current_value._ptr]))
  ...
  def popup_quick_open(self, callback:'Callable'   , base_types:'py4godot_stringnametypedarray.StringNameTypedArray' = None  ) -> None:
    ...
    self._ptr.call_with_return(86,tuple([callback._ptr, base_types._ptr]))
  ...
  def popup_create_dialog(self, callback:'Callable'   , base_type:'object' = None  , current_type:'str' =""  , dialog_title:'str' =""  , type_blocklist:'py4godot_stringnametypedarray.StringNameTypedArray' = None  ) -> None:
    ...
    self._ptr.call_with_return(87,tuple([callback._ptr, py_stringname_base_type._ptr, py_string_current_type._ptr, py_string_dialog_title._ptr, type_blocklist._ptr]))
  ...
  def select_file(self, file:'str'   ) -> None:
    ...
    self._ptr.call_with_return(89,tuple([py_string_file._ptr]))
  ...
  def inspect_object(self, object_:'py4godot_object.Object'   , for_property:'str' =""  , inspector_only:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(94,tuple([object_._ptr, py_string_for_property._ptr, inspector_only]))
  ...
  def edit_resource(self, resource:'py4godot_resource.Resource'   ) -> None:
    ...
    self._ptr.call_with_return(95,tuple([resource._ptr]))
  ...
  def edit_node(self, node:'py4godot_node.Node'   ) -> None:
    ...
    self._ptr.call_with_return(96,tuple([node._ptr]))
  ...
  def edit_script(self, script:'py4godot_script.Script'   , line:'int' =-1  , column:'int' =0  , grab_focus:'bool' =True  ) -> None:
    ...
    self._ptr.call_with_return(97,tuple([script._ptr, line, column, grab_focus]))
  ...
  def open_scene_from_path(self, scene_filepath:'str'   , set_inherited:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(98,tuple([py_string_scene_filepath._ptr, set_inherited]))
  ...
  def reload_scene_from_path(self, scene_filepath:'str'   ) -> None:
    ...
    self._ptr.call_with_return(99,tuple([py_string_scene_filepath._ptr]))

  @functools.native_method
  def set_object_edited(self, object_:'py4godot_object.Object'   , edited:'bool'   ) -> None:
    r'''
    ...
    assert(not object_ is None)
    assert isinstance(object_, get_class('Object')), 'object_ must be Object'
    assert isinstance(edited, bool), 'edited must be bool'
    ...
    self._ptr.call_with_return(100,tuple([object_._ptr, edited]))

  @functools.native_method
  def is_object_edited(self, object_:'py4godot_object.Object'   ) -> typing.Union[bool]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(101,tuple([object_._ptr]))
    return _ret
  ...
  def add_root_node(self, node:'py4godot_node.Node'   ) -> None:
    ...
    self._ptr.call_with_return(105,tuple([node._ptr]))
  ...
  def save_scene_as(self, path:'str'   , with_preview:'bool' =True  ) -> None:
    ...
    self._ptr.call_with_return(107,tuple([py_string_path._ptr, with_preview]))
  ...
  def mark_scene_as_unsaved(self) -> None:
    ...
    self._ptr.call_with_return(110,tuple([]))
  ...
  def play_main_scene(self) -> None:
    ...
    self._ptr.call_with_return(111,tuple([]))
  ...
  def play_current_scene(self) -> None:
    ...
    self._ptr.call_with_return(112,tuple([]))
  ...
  def play_custom_scene(self, scene_filepath:'str'   ) -> None:
    ...
    self._ptr.call_with_return(113,tuple([py_string_scene_filepath._ptr]))
  ...
  def set_movie_maker_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(117,tuple([enabled]))
