...
class TabBar(py4godot_control.Control):
  ...
  @property
  def switch_on_drag_hover(self) -> typing.Union[bool]:
    r''''''
    _ret = self. get_switch_on_drag_hover()
    return _ret
  @switch_on_drag_hover.setter
  def switch_on_drag_hover(self,  value:'bool'):
    self.set_switch_on_drag_hover(value)
  @property
  ...
  def set_tab_count(self, count:'int'   ) -> None:
    ...
    self._ptr.call_with_return(438,tuple([count]))
  ...
  def set_current_tab(self, tab_idx:'int'   ) -> None:
    ...
    self._ptr.call_with_return(440,tuple([tab_idx]))
  ...
  def set_tab_title(self, tab_idx:'int'   , title:'str'   ) -> None:
    ...
    self._ptr.call_with_return(445,tuple([tab_idx, py_string_title._ptr]))
  ...
  def get_tab_title(self, tab_idx:'int'   ) -> typing.Union[str]:
    ...
    _ret._ptr = self._ptr.call_with_return(446,tuple([tab_idx]))
  ...
  def set_tab_tooltip(self, tab_idx:'int'   , tooltip:'str'   ) -> None:
    ...
    self._ptr.call_with_return(447,tuple([tab_idx, py_string_tooltip._ptr]))
  ...
  def get_tab_tooltip(self, tab_idx:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(448,tuple([tab_idx]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def set_tab_text_direction(self, tab_idx:'int'   , direction:'int'  ) -> None:
    ...
    self._ptr.call_with_return(449,tuple([tab_idx, direction]))
  ...
  def get_tab_text_direction(self, tab_idx:'int'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = self._ptr.call_with_return(450,tuple([tab_idx]))
    return _ret
  ...
  def set_tab_language(self, tab_idx:'int'   , language:'str'   ) -> None:
    ...
    self._ptr.call_with_return(451,tuple([tab_idx, py_string_language._ptr]))
  ...
  def get_tab_language(self, tab_idx:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(452,tuple([tab_idx]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def set_tab_icon(self, tab_idx:'int'   , icon:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(453,tuple([tab_idx, icon._ptr]))
  ...
  def get_tab_icon(self, tab_idx:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(454,tuple([tab_idx]))
  ...
  def set_tab_icon_max_width(self, tab_idx:'int'   , width:'int'   ) -> None:
    ...
    self._ptr.call_with_return(455,tuple([tab_idx, width]))
  ...
  def get_tab_icon_max_width(self, tab_idx:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(456,tuple([tab_idx]))
    return _ret
  ...
  def set_tab_button_icon(self, tab_idx:'int'   , icon:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(457,tuple([tab_idx, icon._ptr]))
  ...
  def get_tab_button_icon(self, tab_idx:'int'   ) -> typing.Any:
    ...
    _ret = classes.Object.Object.construct_without_init() #Smart casted to: Texture2D
    _ret._ptr = self._ptr.call_with_return(458,tuple([tab_idx]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def set_tab_disabled(self, tab_idx:'int'   , disabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(459,tuple([tab_idx, disabled]))
  ...
  def is_tab_disabled(self, tab_idx:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(460,tuple([tab_idx]))
    return _ret
  ...
  def set_tab_hidden(self, tab_idx:'int'   , hidden:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(461,tuple([tab_idx, hidden]))
  ...
  def is_tab_hidden(self, tab_idx:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(462,tuple([tab_idx]))
    return _ret
  ...
  def set_tab_metadata(self, tab_idx:'int'   , metadata:'object'   ) -> None:
    ...
    self._ptr.call_with_return(463,tuple([tab_idx, metadata]))
  ...
  def get_tab_metadata(self, tab_idx:'int'   ) -> typing.Union[typing.Any]:
    ...
    _ret = None
    _ret = self._ptr.call_with_return(464,tuple([tab_idx]))
    return _ret
  ...
  def remove_tab(self, tab_idx:'int'   ) -> None:
    ...
    self._ptr.call_with_return(465,tuple([tab_idx]))
  ...
  def add_tab(self, title:'str' =""  , icon:'py4godot_texture2d.Texture2D' = None  ) -> None:
    ...
    self._ptr.call_with_return(466,tuple([py_string_title._ptr, icon._ptr]))
  ...
  def get_tab_idx_at_point(self, point:'Vector2'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(467,tuple([point._ptr]))
    return _ret
  ...
  def set_tab_alignment(self, alignment:'int'  ) -> None:
    ...
    self._ptr.call_with_return(468,tuple([alignment]))
  ...
  def set_clip_tabs(self, clip_tabs:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(470,tuple([clip_tabs]))
  ...
  def get_tab_rect(self, tab_idx:'int'   ) -> typing.Union['Rect2']:
    ...
    _ret._ptr = self._ptr.call_with_return(475,tuple([tab_idx]))
    return _ret
  ...
  def move_tab(self, from_:'int'   , to:'int'   ) -> None:
    ...
    self._ptr.call_with_return(476,tuple([from_, to]))
  ...
  def set_tab_close_display_policy(self, policy:'int'  ) -> None:
    ...
    self._ptr.call_with_return(479,tuple([policy]))
  ...
  def set_max_tab_width(self, width:'int'   ) -> None:
    ...
    self._ptr.call_with_return(481,tuple([width]))
  ...
  def set_drag_to_rearrange_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(485,tuple([enabled]))
  ...
  @functools.native_method
  def set_switch_on_drag_hover(self, enabled:'bool'   ) -> None:
    r''''''

    assert isinstance(enabled, bool), 'enabled must be bool'


    self.py__switch_on_drag_hover = enabled
  ...
  @functools.native_method
  def get_switch_on_drag_hover(self) -> typing.Union[bool]:
    r''''''
  ...
  def set_tabs_rearrange_group(self, group_id:'int'   ) -> None:
    ...
    self._ptr.call_with_return(489,tuple([group_id]))
  ...
  def set_scroll_to_selected(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(491,tuple([enabled]))
  ...
  def set_select_with_rmb(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(493,tuple([enabled]))
  ...
  def set_deselect_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(495,tuple([enabled]))
  ...
  def clear_tabs(self) -> None:
    ...
    self._ptr.call_with_return(497,tuple([]))
