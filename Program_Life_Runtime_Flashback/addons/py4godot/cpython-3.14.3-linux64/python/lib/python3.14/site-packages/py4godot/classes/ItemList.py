...
class ItemList(py4godot_control.Control):
  ...
  @property
  def scroll_hint_mode(self) -> typing.Union[int]:
    r''''''
    _ret = self. get_scroll_hint_mode()
    return _ret
  @scroll_hint_mode.setter
  def scroll_hint_mode(self,  value:'int'):
    self.set_scroll_hint_mode(value)
  @property
  def tile_scroll_hint(self) -> typing.Union[bool]:
    r''''''
    _ret = self. is_scroll_hint_tiled()
    return _ret
  @tile_scroll_hint.setter
  def tile_scroll_hint(self,  value:'bool'):
    self.set_tile_scroll_hint(value)
  @property
  ...
  def add_item(self, text:'str'   , icon:'py4godot_texture2d.Texture2D' = None  , selectable:'bool' =True  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(438,tuple([py_string_text._ptr, icon._ptr, selectable]))
    return _ret
  ...
  def add_icon_item(self, icon:'py4godot_texture2d.Texture2D'   , selectable:'bool' =True  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(439,tuple([icon._ptr, selectable]))
    return _ret
  ...
  def set_item_text(self, idx:'int'   , text:'str'   ) -> None:
    ...
    self._ptr.call_with_return(440,tuple([idx, py_string_text._ptr]))
  ...
  def get_item_text(self, idx:'int'   ) -> typing.Union[str]:
    ...
    _ret._ptr = self._ptr.call_with_return(441,tuple([idx]))
  ...
  def set_item_icon(self, idx:'int'   , icon:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(442,tuple([idx, icon._ptr]))
  ...
  def get_item_icon(self, idx:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(443,tuple([idx]))
  ...
  def set_item_text_direction(self, idx:'int'   , direction:'int'  ) -> None:
    ...
    self._ptr.call_with_return(444,tuple([idx, direction]))
  ...
  def get_item_text_direction(self, idx:'int'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = self._ptr.call_with_return(445,tuple([idx]))
    return _ret
  ...
  def set_item_language(self, idx:'int'   , language:'str'   ) -> None:
    ...
    self._ptr.call_with_return(446,tuple([idx, py_string_language._ptr]))
  ...
  def get_item_language(self, idx:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(447,tuple([idx]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def set_item_auto_translate_mode(self, idx:'int'   , mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(448,tuple([idx, mode]))
  ...
  def get_item_auto_translate_mode(self, idx:'int'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = self._ptr.call_with_return(449,tuple([idx]))
    return _ret
  ...
  def set_item_icon_transposed(self, idx:'int'   , transposed:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(450,tuple([idx, transposed]))
  ...
  def is_item_icon_transposed(self, idx:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(451,tuple([idx]))
    return _ret
  ...
  def set_item_icon_region(self, idx:'int'   , rect:'Rect2'   ) -> None:
    ...
    self._ptr.call_with_return(452,tuple([idx, rect._ptr]))
  ...
  def get_item_icon_region(self, idx:'int'   ) -> typing.Union['Rect2']:
    ...
    _ret._ptr = self._ptr.call_with_return(453,tuple([idx]))
    return _ret
  ...
  def set_item_icon_modulate(self, idx:'int'   , modulate:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(454,tuple([idx, modulate._ptr]))
  ...
  def get_item_icon_modulate(self, idx:'int'   ) -> typing.Union['Color']:
    ...
    _ret._ptr = self._ptr.call_with_return(455,tuple([idx]))
    return _ret
  ...
  def set_item_selectable(self, idx:'int'   , selectable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(456,tuple([idx, selectable]))
  ...
  def is_item_selectable(self, idx:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(457,tuple([idx]))
    return _ret
  ...
  def set_item_disabled(self, idx:'int'   , disabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(458,tuple([idx, disabled]))
  ...
  def is_item_disabled(self, idx:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(459,tuple([idx]))
    return _ret
  ...
  def set_item_metadata(self, idx:'int'   , metadata:'object'   ) -> None:
    ...
    self._ptr.call_with_return(460,tuple([idx, metadata]))
  ...
  def get_item_metadata(self, idx:'int'   ) -> typing.Union[typing.Any]:
    ...
    _ret = None
    _ret = self._ptr.call_with_return(461,tuple([idx]))
    return _ret
  ...
  def set_item_custom_bg_color(self, idx:'int'   , custom_bg_color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(462,tuple([idx, custom_bg_color._ptr]))
  ...
  def get_item_custom_bg_color(self, idx:'int'   ) -> typing.Union['Color']:
    ...
    _ret = Color.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(463,tuple([idx]))
    return _ret
  ...
  def set_item_custom_fg_color(self, idx:'int'   , custom_fg_color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(464,tuple([idx, custom_fg_color._ptr]))
  ...
  def get_item_rect(self, idx:'int'   , expand:'bool' =True  ) -> typing.Union['Rect2']:
    ...
    _ret = Rect2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(466,tuple([idx, expand]))
    return _ret
  ...
  def set_item_tooltip_enabled(self, idx:'int'   , enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(467,tuple([idx, enable]))
  ...
  def is_item_tooltip_enabled(self, idx:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(468,tuple([idx]))
    return _ret
  ...
  def set_item_tooltip(self, idx:'int'   , tooltip:'str'   ) -> None:
    ...
    self._ptr.call_with_return(469,tuple([idx, py_string_tooltip._ptr]))
  ...
  def get_item_tooltip(self, idx:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(470,tuple([idx]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def select(self, idx:'int'   , single:'bool' =True  ) -> None:
    ...
    self._ptr.call_with_return(471,tuple([idx, single]))
  ...
  def deselect(self, idx:'int'   ) -> None:
    ...
    self._ptr.call_with_return(472,tuple([idx]))
  ...
  def is_selected(self, idx:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(474,tuple([idx]))
    return _ret
  ...
  def move_item(self, from_idx:'int'   , to_idx:'int'   ) -> None:
    ...
    self._ptr.call_with_return(476,tuple([from_idx, to_idx]))
  ...
  def set_item_count(self, count:'int'   ) -> None:
    ...
    self._ptr.call_with_return(477,tuple([count]))
  ...
  def remove_item(self, idx:'int'   ) -> None:
    ...
    self._ptr.call_with_return(479,tuple([idx]))
  ...
  def set_fixed_column_width(self, width:'int'   ) -> None:
    ...
    self._ptr.call_with_return(482,tuple([width]))
  ...
  def set_max_text_lines(self, lines:'int'   ) -> None:
    ...
    self._ptr.call_with_return(486,tuple([lines]))
  ...
  def set_max_columns(self, amount:'int'   ) -> None:
    ...
    self._ptr.call_with_return(488,tuple([amount]))
  ...
  def set_select_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(490,tuple([mode]))
  ...
  def set_icon_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(492,tuple([mode]))
  ...
  def set_fixed_icon_size(self, size:'Vector2i'   ) -> None:
    ...
    self._ptr.call_with_return(494,tuple([size._ptr]))
  ...
  def get_fixed_icon_size(self) -> typing.Union['Vector2i']:
    ...
    _ret._ptr = self._ptr.call_with_return(495,tuple([]))
  ...
  def set_icon_scale(self, scale:'float'   ) -> None:
    ...
    self._ptr.call_with_return(496,tuple([scale]))
  ...
  def set_allow_rmb_select(self, allow:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(498,tuple([allow]))
  ...
  def set_allow_reselect(self, allow:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(500,tuple([allow]))
  ...
  def set_allow_search(self, allow:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(502,tuple([allow]))
  ...
  def set_auto_height(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(506,tuple([enable]))
  ...
  def get_item_at_position(self, position:'Vector2'   , exact:'bool' =False  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(509,tuple([position._ptr, exact]))
    return _ret
  ...
  def get_v_scroll_bar(self) -> typing.Union['py4godot_vscrollbar.VScrollBar']:
    ...
    _ret._ptr = self._ptr.call_with_return(511,tuple([]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  @functools.native_method
  def set_scroll_hint_mode(self, scroll_hint_mode:'int'  ) -> None:
    r''''''

    assert isinstance(scroll_hint_mode, (int, float)), 'scroll_hint_mode must be int or float'


    self.py__scroll_hint_mode = scroll_hint_mode
    ...
    self._ptr.call_with_return(513,tuple([scroll_hint_mode]))

  @functools.native_method
  def get_scroll_hint_mode(self) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def set_tile_scroll_hint(self, tile_scroll_hint:'bool'   ) -> None:
    r''''''

    assert isinstance(tile_scroll_hint, bool), 'tile_scroll_hint must be bool'


    self.py__tile_scroll_hint = tile_scroll_hint
    ...
    self._ptr.call_with_return(515,tuple([tile_scroll_hint]))

  @functools.native_method
  def is_scroll_hint_tiled(self) -> typing.Union[bool]:
    r''''''
  ...
  def set_text_overrun_behavior(self, overrun_behavior:'int'  ) -> None:
    ...
    self._ptr.call_with_return(517,tuple([overrun_behavior]))
  ...
  def set_wraparound_items(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(519,tuple([enable]))
  ...
  def force_update_list_size(self) -> None:
    ...
    self._ptr.call_with_return(521,tuple([]))
