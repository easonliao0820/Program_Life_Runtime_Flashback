...
class Line2D(py4godot_node2d.Node2D):
  ...
  def set_points(self, points:'PackedVector2Array'   ) -> None:
    ...
    self._ptr.call_with_return(305,tuple([points._ptr]))
  ...
  def set_point_position(self, index:'int'   , position:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(307,tuple([index, position._ptr]))
  ...
  def get_point_position(self, index:'int'   ) -> typing.Union['Vector2']:
    ...
    _ret._ptr = self._ptr.call_with_return(308,tuple([index]))
    return _ret
  ...
  def add_point(self, position:'Vector2'   , index:'int' =-1  ) -> None:
    ...
    self._ptr.call_with_return(310,tuple([position._ptr, index]))
  ...
  def remove_point(self, index:'int'   ) -> None:
    ...
    self._ptr.call_with_return(311,tuple([index]))
  ...
  def set_closed(self, closed:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(313,tuple([closed]))
  ...
  def set_width(self, width:'float'   ) -> None:
    ...
    self._ptr.call_with_return(315,tuple([width]))
  ...
  def set_curve(self, curve:'py4godot_curve.Curve'   ) -> None:
    ...
    self._ptr.call_with_return(317,tuple([curve._ptr]))
  ...
  def set_gradient(self, color:'py4godot_gradient.Gradient'   ) -> None:
    ...
    self._ptr.call_with_return(321,tuple([color._ptr]))
  ...
  def set_texture(self, texture:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(323,tuple([texture._ptr]))
  ...
  def set_sharp_limit(self, limit:'float'   ) -> None:
    ...
    self._ptr.call_with_return(333,tuple([limit]))
  ...
  def set_round_precision(self, precision:'int'   ) -> None:
    ...
    self._ptr.call_with_return(335,tuple([precision]))
  ...
  def set_antialiased(self, antialiased:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(337,tuple([antialiased]))
