...
class GeometryInstance3D(py4godot_visualinstance3d.VisualInstance3D):
  ...
  @property
  def material_override(self) -> typing.Union['py4godot_standardmaterial3d.StandardMaterial3D','py4godot_basematerial3d.BaseMaterial3D','py4godot_ormmaterial3d.ORMMaterial3D']:
    r''''''
  ...
  @property
  def material_overlay(self) -> typing.Union['py4godot_standardmaterial3d.StandardMaterial3D','py4godot_basematerial3d.BaseMaterial3D','py4godot_ormmaterial3d.ORMMaterial3D']:
    r''''''
