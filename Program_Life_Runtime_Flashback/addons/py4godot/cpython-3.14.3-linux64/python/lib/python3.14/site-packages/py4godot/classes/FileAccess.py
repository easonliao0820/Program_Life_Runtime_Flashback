...
class FileAccess(py4godot_refcounted.RefCounted):
  ...
  def open(path:'str'   , flags:'int'  ) -> typing.Union['typing.Self']:
    ...
    _ret._ptr = static_method(1022,0,tuple([py_string_path._ptr, flags]))
  ...
  def open_encrypted(path:'str'   , mode_flags:'int'  , key:'PackedByteArray'   , iv:'PackedByteArray' = None  ) -> typing.Union['typing.Self']:
    ...
    _ret = FileAccess.construct_without_init()
    _ret._ptr = static_method(1022,1,tuple([py_string_path._ptr, mode_flags, key._ptr, iv._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def open_encrypted_with_pass(path:'str'   , mode_flags:'int'  , pass_:'str'   ) -> typing.Union['typing.Self']:
    ...
    _ret = FileAccess.construct_without_init()
    _ret._ptr = static_method(1022,2,tuple([py_string_path._ptr, mode_flags, py_string_pass_._ptr]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def open_compressed(path:'str'   , mode_flags:'int'  , compression_mode:'int'  =0) -> typing.Union['typing.Self']:
    ...
    _ret = FileAccess.construct_without_init()
    _ret._ptr = static_method(1022,3,tuple([py_string_path._ptr, mode_flags, compression_mode]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def get_open_error() -> typing.Union[int]:
    ...
    _ret:int
    _ret = static_method(1022,4,tuple([]))
    return _ret
  ...
  def create_temp(mode_flags:'int'  , prefix:'str' =""  , extension:'str' =""  , keep:'bool' =False  ) -> typing.Union['typing.Self']:
    ...
    _ret = FileAccess.construct_without_init()
    _ret._ptr = static_method(1022,5,tuple([mode_flags, py_string_prefix._ptr, py_string_extension._ptr, keep]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def get_file_as_bytes(path:'str'   ) -> typing.Union['PackedByteArray']:
    ...
    _ret._ptr = static_method(1022,6,tuple([py_string_path._ptr]))
    return _ret
  ...
  def get_file_as_string(path:'str'   ) -> typing.Union[str]:
    ...
    _ret._ptr = static_method(1022,7,tuple([py_string_path._ptr]))
  ...
  def get_md5(path:'str'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = static_method(1022,8,tuple([py_string_path._ptr]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def get_sha256(path:'str'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = static_method(1022,9,tuple([py_string_path._ptr]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def file_exists(path:'str'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = static_method(1022,10,tuple([py_string_path._ptr]))
    return _ret
  ...
  def get_modified_time(file:'str'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = static_method(1022,11,tuple([py_string_file._ptr]))
    return _ret
  ...
  def get_access_time(file:'str'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = static_method(1022,12,tuple([py_string_file._ptr]))
    return _ret
  ...
  def get_size(file:'str'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = static_method(1022,13,tuple([py_string_file._ptr]))
    return _ret
  ...
  def get_unix_permissions(file:'str'   ) -> typing.Union[int]:
    ...
    _ret
    _ret = static_method(1022,14,tuple([py_string_file._ptr]))
    return _ret
  ...
  def set_unix_permissions(file:'str'   , permissions:'int'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = static_method(1022,15,tuple([py_string_file._ptr, permissions]))
    return _ret
  ...
  def get_hidden_attribute(file:'str'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = static_method(1022,16,tuple([py_string_file._ptr]))
    return _ret
  ...
  def set_hidden_attribute(file:'str'   , hidden:'bool'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = static_method(1022,17,tuple([py_string_file._ptr, hidden]))
    return _ret
  ...
  def set_read_only_attribute(file:'str'   , ro:'bool'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = static_method(1022,18,tuple([py_string_file._ptr, ro]))
    return _ret
  ...
  def get_read_only_attribute(file:'str'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = static_method(1022,19,tuple([py_string_file._ptr]))
    return _ret


  @staticmethod
  def get_extended_attribute(file:'str'   , attribute_name:'str'   ) -> typing.Union['PackedByteArray']:
    r'''
    ...
    assert(not file is None)
    assert isinstance(file, (str, String)), 'file must be str or String'
    assert(not attribute_name is None)
    assert isinstance(attribute_name, (str, String)), 'attribute_name must be str or String'
    ...
    assert(isinstance(file, (str, String)))
    py_string_file = file if isinstance(file, StringName) else c_utils.py_string_to_string(file)
    assert(isinstance(attribute_name, (str, String)))
    py_string_attribute_name = attribute_name if isinstance(attribute_name, StringName) else c_utils.py_string_to_string(attribute_name)

    _ret = PackedByteArray.construct_without_init()
    _ret._ptr = static_method(1022,20,tuple([py_string_file._ptr, py_string_attribute_name._ptr]))
    return _ret


  @staticmethod
  def get_extended_attribute_string(file:'str'   , attribute_name:'str'   ) -> typing.Union[str]:
    r'''
    ...
    _ret = String.construct_without_init()
    _ret._ptr = static_method(1022,21,tuple([py_string_file._ptr, py_string_attribute_name._ptr]))
    return utils.gd_string_to_py_string(_ret)


  @staticmethod
  def set_extended_attribute(file:'str'   , attribute_name:'str'   , data:'PackedByteArray'   ) -> typing.Union[int]:
    r'''
    ...
    _ret:int
    _ret = static_method(1022,22,tuple([py_string_file._ptr, py_string_attribute_name._ptr, data._ptr]))
    return _ret


  @staticmethod
  def set_extended_attribute_string(file:'str'   , attribute_name:'str'   , data:'str'   ) -> typing.Union[int]:
    r'''
    ...
    _ret:int
    _ret = static_method(1022,23,tuple([py_string_file._ptr, py_string_attribute_name._ptr, py_string_data._ptr]))
    return _ret


  @staticmethod
  def remove_extended_attribute(file:'str'   , attribute_name:'str'   ) -> typing.Union[int]:
    r'''
    ...
    _ret:int
    _ret = static_method(1022,24,tuple([py_string_file._ptr, py_string_attribute_name._ptr]))
    return _ret


  @staticmethod
  def get_extended_attributes_list(file:'str'   ) -> typing.Union['PackedStringArray']:
    r'''
    ...
    _ret = PackedStringArray.construct_without_init()
    _ret._ptr = static_method(1022,25,tuple([py_string_file._ptr]))
    return _ret
