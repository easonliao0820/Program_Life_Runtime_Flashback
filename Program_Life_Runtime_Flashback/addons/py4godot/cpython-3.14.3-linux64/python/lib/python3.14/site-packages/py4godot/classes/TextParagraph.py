...
class TextParagraph(py4godot_refcounted.RefCounted):
  ...
  def duplicate(self) -> typing.Union['typing.Self']:
    ...
    _ret = TextParagraph.construct_without_init()
  ...
  def set_direction(self, direction:'int'  ) -> None:
    ...
    self._ptr.call_with_return(55,tuple([direction]))
  ...
  def set_custom_punctuation(self, custom_punctuation:'str'   ) -> None:
    ...
    self._ptr.call_with_return(58,tuple([py__string_custom_punctuation._ptr]))
  ...
  def set_orientation(self, orientation:'int'  ) -> None:
    ...
    self._ptr.call_with_return(60,tuple([orientation]))
  ...
  def set_bidi_override(self, override:'Array'   ) -> None:
    ...
    self._ptr.call_with_return(66,tuple([override._ptr]))
  ...
  def set_dropcap(self, text:'str'   , font:'py4godot_font.Font'   , font_size:'int'   , dropcap_margins:'Rect2' = None  , language:'str' =""  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(67,tuple([py_string_text._ptr, font._ptr, font_size, dropcap_margins._ptr, py_string_language._ptr]))
    return _ret
  ...
  def add_string(self, text:'str'   , font:'py4godot_font.Font'   , font_size:'int'   , language:'str' =""  , meta:'object' =None  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(69,tuple([py_string_text._ptr, font._ptr, font_size, py_string_language._ptr, meta]))
    return _ret
  ...
  def add_object(self, key:'object'   , size:'Vector2'   , inline_align:'int'  =5, length:'int' =1  , baseline:'float' =0.0  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(70,tuple([key, size._ptr, inline_align, length, baseline]))
    return _ret
  ...
  def resize_object(self, key:'object'   , size:'Vector2'   , inline_align:'int'  =5, baseline:'float' =0.0  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(71,tuple([key, size._ptr, inline_align, baseline]))
    return _ret


  @functools.native_method
  def has_object(self, key:'object'   ) -> typing.Union[bool]:
    r'''
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(72,tuple([key]))
    return _ret
  ...
  def set_alignment(self, alignment:'int'  ) -> None:
    ...
    self._ptr.call_with_return(73,tuple([alignment]))
  ...
  def tab_align(self, tab_stops:'PackedFloat32Array'   ) -> None:
    ...
    self._ptr.call_with_return(75,tuple([tab_stops._ptr]))
  ...
  def set_justification_flags(self, flags:'int'   ) -> None:
    ...
    self._ptr.call_with_return(78,tuple([flags]))
  ...
  def set_text_overrun_behavior(self, overrun_behavior:'int'  ) -> None:
    ...
    self._ptr.call_with_return(80,tuple([overrun_behavior]))
  ...
  def set_ellipsis_char(self, char:'str'   ) -> None:
    ...
    self._ptr.call_with_return(82,tuple([py__string_char._ptr]))
  ...
  def set_width(self, width:'float'   ) -> None:
    ...
    self._ptr.call_with_return(84,tuple([width]))
  ...
  def get_line_rid(self, line:'int'   ) -> typing.Union['RID']:
    ...
    _ret = RID.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(89,tuple([line]))
    return _ret
  ...
  def set_max_lines_visible(self, max_lines_visible:'int'   ) -> None:
    ...
    self._ptr.call_with_return(93,tuple([max_lines_visible]))
  ...
  def set_line_spacing(self, line_spacing:'float'   ) -> None:
    ...
    self._ptr.call_with_return(95,tuple([line_spacing]))
  ...
  def get_line_object_rect(self, line:'int'   , key:'object'   ) -> typing.Union['Rect2']:
    ...
    _ret._ptr = self._ptr.call_with_return(98,tuple([line, key]))
    return _ret
  ...
  def get_line_size(self, line:'int'   ) -> typing.Union['Vector2']:
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(99,tuple([line]))
    return _ret
  ...
  def get_line_range(self, line:'int'   ) -> typing.Union['Vector2i']:
    ...
    _ret = Vector2i.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(100,tuple([line]))
    return _ret
  ...
  def get_line_underline_position(self, line:'int'   ) -> typing.Union[float]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(104,tuple([line]))
    return _ret
  ...
  def get_line_underline_thickness(self, line:'int'   ) -> typing.Union[float]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(105,tuple([line]))
    return _ret
  ...
  def draw(self, canvas:'RID'   , pos:'Vector2'   , color:'Color' = None  , dc_color:'Color' = None  , oversampling:'float' =0.0  ) -> None:
    ...
    self._ptr.call_with_return(108,tuple([canvas._ptr, pos._ptr, color._ptr, dc_color._ptr, oversampling]))
  ...
  def draw_outline(self, canvas:'RID'   , pos:'Vector2'   , outline_size:'int' =1  , color:'Color' = None  , dc_color:'Color' = None  , oversampling:'float' =0.0  ) -> None:
    ...
    self._ptr.call_with_return(109,tuple([canvas._ptr, pos._ptr, outline_size, color._ptr, dc_color._ptr, oversampling]))
  ...
  def draw_line(self, canvas:'RID'   , pos:'Vector2'   , line:'int'   , color:'Color' = None  , oversampling:'float' =0.0  ) -> None:
    ...
    self._ptr.call_with_return(110,tuple([canvas._ptr, pos._ptr, line, color._ptr, oversampling]))
  ...
  def draw_line_outline(self, canvas:'RID'   , pos:'Vector2'   , line:'int'   , outline_size:'int' =1  , color:'Color' = None  , oversampling:'float' =0.0  ) -> None:
    ...
    self._ptr.call_with_return(111,tuple([canvas._ptr, pos._ptr, line, outline_size, color._ptr, oversampling]))
  ...
  def draw_dropcap(self, canvas:'RID'   , pos:'Vector2'   , color:'Color' = None  , oversampling:'float' =0.0  ) -> None:
    ...
    self._ptr.call_with_return(112,tuple([canvas._ptr, pos._ptr, color._ptr, oversampling]))
  ...
  def draw_dropcap_outline(self, canvas:'RID'   , pos:'Vector2'   , outline_size:'int' =1  , color:'Color' = None  , oversampling:'float' =0.0  ) -> None:
    ...
    self._ptr.call_with_return(113,tuple([canvas._ptr, pos._ptr, outline_size, color._ptr, oversampling]))
  ...
  def hit_test(self, coords:'Vector2'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(114,tuple([coords._ptr]))
    return _ret
