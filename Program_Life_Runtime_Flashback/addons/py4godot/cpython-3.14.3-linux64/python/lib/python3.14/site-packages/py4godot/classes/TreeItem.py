...
class TreeItem(py4godot_object.Object):
  ...
  @functools.native_method
  def set_custom_stylebox(self, column:'int'   , stylebox:'py4godot_stylebox.StyleBox'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(97,tuple([column, stylebox._ptr]))

  @functools.native_method
  def get_custom_stylebox(self, column:'int'   ) -> typing.Union['py4godot_stylebox.StyleBox','py4godot_styleboxtexture.StyleBoxTexture','py4godot_styleboxflat.StyleBoxFlat','py4godot_styleboxempty.StyleBoxEmpty','py4godot_styleboxline.StyleBoxLine']:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(98,tuple([column]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def is_any_collapsed(self, only_visible:'bool' =False  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(102,tuple([only_visible]))
    return _ret
  ...
  def set_custom_minimum_height(self, height:'int'   ) -> None:
    ...
    self._ptr.call_with_return(107,tuple([height]))
  ...
  def set_selectable(self, column:'int'   , selectable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(109,tuple([column, selectable]))
  ...
  def is_selectable(self, column:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(110,tuple([column]))
    return _ret
  ...
  def is_selected(self, column:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(111,tuple([column]))
    return _ret
  ...
  def select(self, column:'int'   ) -> None:
    ...
    self._ptr.call_with_return(112,tuple([column]))
  ...
  def deselect(self, column:'int'   ) -> None:
    ...
    self._ptr.call_with_return(113,tuple([column]))
  ...
  def set_editable(self, column:'int'   , enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(114,tuple([column, enabled]))
  ...
  def is_editable(self, column:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(115,tuple([column]))
    return _ret
  ...
  def set_custom_color(self, column:'int'   , color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(116,tuple([column, color._ptr]))
  ...
  def get_custom_color(self, column:'int'   ) -> typing.Union['Color']:
    ...
    _ret = Color.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(117,tuple([column]))
    return _ret
  ...
  def clear_custom_color(self, column:'int'   ) -> None:
    ...
    self._ptr.call_with_return(118,tuple([column]))
  ...
  def set_custom_font(self, column:'int'   , font:'py4godot_font.Font'   ) -> None:
    ...
    self._ptr.call_with_return(119,tuple([column, font._ptr]))

  @functools.native_method
  def get_custom_font(self, column:'int'   ) -> typing.Union['py4godot_fontfile.FontFile','py4godot_fontvariation.FontVariation','py4godot_font.Font','py4godot_systemfont.SystemFont']:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(120,tuple([column]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def set_custom_font_size(self, column:'int'   , font_size:'int'   ) -> None:
    ...
    self._ptr.call_with_return(121,tuple([column, font_size]))
  ...
  def get_custom_font_size(self, column:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(122,tuple([column]))
    return _ret
  ...
  def set_custom_bg_color(self, column:'int'   , color:'Color'   , just_outline:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(123,tuple([column, color._ptr, just_outline]))
  ...
  def clear_custom_bg_color(self, column:'int'   ) -> None:
    ...
    self._ptr.call_with_return(124,tuple([column]))
  ...
  def get_custom_bg_color(self, column:'int'   ) -> typing.Union['Color']:
    ...
    _ret = Color.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(125,tuple([column]))
    return _ret
  ...
  def set_custom_as_button(self, column:'int'   , enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(126,tuple([column, enable]))
  ...
  def is_custom_set_as_button(self, column:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(127,tuple([column]))
    return _ret
  ...
  def add_button(self, column:'int'   , button:'py4godot_texture2d.Texture2D'   , id:'int' =-1  , disabled:'bool' =False  , tooltip_text:'str' =""  , description:'str' =""  ) -> None:
    ...
    self._ptr.call_with_return(129,tuple([column, button._ptr, id, disabled, py_string_tooltip_text._ptr, py_string_description._ptr]))
  ...
  def get_button_count(self, column:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(130,tuple([column]))
    return _ret
  ...
  def get_button_tooltip_text(self, column:'int'   , button_index:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(131,tuple([column, button_index]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def get_button_id(self, column:'int'   , button_index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(132,tuple([column, button_index]))
    return _ret
  ...
  def get_button_by_id(self, column:'int'   , id:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(133,tuple([column, id]))
    return _ret
  ...
  def get_button_color(self, column:'int'   , id:'int'   ) -> typing.Union['Color']:
    ...
    _ret = Color.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(134,tuple([column, id]))
    return _ret
  ...
  def get_button(self, column:'int'   , button_index:'int'   ) -> typing.Any:
    ...
    _ret = classes.Object.Object.construct_without_init() #Smart casted to: Texture2D
    _ret._ptr = self._ptr.call_with_return(135,tuple([column, button_index]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def set_button_tooltip_text(self, column:'int'   , button_index:'int'   , tooltip:'str'   ) -> None:
    ...
    self._ptr.call_with_return(136,tuple([column, button_index, py_string_tooltip._ptr]))
  ...
  def set_button(self, column:'int'   , button_index:'int'   , button:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(137,tuple([column, button_index, button._ptr]))
  ...
  def erase_button(self, column:'int'   , button_index:'int'   ) -> None:
    ...
    self._ptr.call_with_return(138,tuple([column, button_index]))
  ...
  def set_button_description(self, column:'int'   , button_index:'int'   , description:'str'   ) -> None:
    ...
    self._ptr.call_with_return(139,tuple([column, button_index, py_string_description._ptr]))
  ...
  def set_button_disabled(self, column:'int'   , button_index:'int'   , disabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(140,tuple([column, button_index, disabled]))
  ...
  def set_button_color(self, column:'int'   , button_index:'int'   , color:'Color'   ) -> None:
    ...
    self._ptr.call_with_return(141,tuple([column, button_index, color._ptr]))
  ...
  def is_button_disabled(self, column:'int'   , button_index:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(142,tuple([column, button_index]))
    return _ret
  ...
  def set_tooltip_text(self, column:'int'   , tooltip:'str'   ) -> None:
    ...
    self._ptr.call_with_return(143,tuple([column, py_string_tooltip._ptr]))
  ...
  def get_tooltip_text(self, column:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(144,tuple([column]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def set_text_alignment(self, column:'int'   , text_alignment:'int'  ) -> None:
    ...
    self._ptr.call_with_return(145,tuple([column, text_alignment]))
  ...
  def set_expand_right(self, column:'int'   , enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(147,tuple([column, enable]))
  ...
  def get_expand_right(self, column:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(148,tuple([column]))
    return _ret
  ...
  def set_disable_folding(self, disable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(149,tuple([disable]))
  ...
  def create_child(self, index:'int' =-1  ) -> typing.Union['typing.Self']:
    ...
    _ret._ptr = self._ptr.call_with_return(151,tuple([index]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def add_child(self, child:'TreeItem'   ) -> None:
    ...
    self._ptr.call_with_return(152,tuple([child._ptr]))
  ...
  def remove_child(self, child:'TreeItem'   ) -> None:
    ...
    self._ptr.call_with_return(153,tuple([child._ptr]))
  ...
  def get_first_child(self) -> typing.Union['typing.Self']:
    ...
    _ret = TreeItem.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(158,tuple([]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def get_next_visible(self, wrap:'bool' =False  ) -> typing.Union['typing.Self']:
    ...
    _ret = TreeItem.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(161,tuple([wrap]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def get_prev_visible(self, wrap:'bool' =False  ) -> typing.Union['typing.Self']:
    ...
    _ret = TreeItem.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(162,tuple([wrap]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def get_children(self) -> typing.Union['py4godot_treeitemtypedarray.TreeItemTypedArray']:
    ...
    _ret._ptr = self._ptr.call_with_return(165,tuple([]))
    return _ret
  ...
  def move_before(self, item:'TreeItem'   ) -> None:
    ...
    self._ptr.call_with_return(167,tuple([item._ptr]))
  ...
  def move_after(self, item:'TreeItem'   ) -> None:
    ...
    self._ptr.call_with_return(168,tuple([item._ptr]))
  ...
  def call_recursive(self, method:'object'   , *varargs) -> None:
    ...
    self._ptr.call_with_return(169,tuple([py_stringname_method._ptr, *varargs]))
