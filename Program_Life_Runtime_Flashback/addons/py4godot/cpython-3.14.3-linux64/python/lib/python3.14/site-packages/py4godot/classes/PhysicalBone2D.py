...
class PhysicalBone2D(py4godot_rigidbody2d.RigidBody2D):
  ...
  def get_joint(self) -> typing.Union['py4godot_groovejoint2d.GrooveJoint2D','py4godot_pinjoint2d.PinJoint2D','py4godot_joint2d.Joint2D','py4godot_dampedspringjoint2d.DampedSpringJoint2D']:
    r'''
  ...
  def set_auto_configure_joint(self, auto_configure_joint:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(411,tuple([auto_configure_joint]))
  ...
  def set_simulate_physics(self, simulate_physics:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(412,tuple([simulate_physics]))
  ...
  def is_simulating_physics(self) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(414,tuple([]))
    return _ret
  ...
  def set_bone2d_nodepath(self, nodepath:'object'   ) -> None:
    ...
    self._ptr.call_with_return(415,tuple([py_nodepath_nodepath._ptr]))
  ...
  def set_bone2d_index(self, bone_index:'int'   ) -> None:
    ...
    self._ptr.call_with_return(417,tuple([bone_index]))
  ...
  def set_follow_bone_when_simulating(self, follow_bone:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(419,tuple([follow_bone]))
