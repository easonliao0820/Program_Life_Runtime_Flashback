...
class RayCast2D(py4godot_node2d.Node2D):
  ...
  def remove_exception_rid(self, rid:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(318,tuple([rid._ptr]))
  ...
  def remove_exception(self, node:'py4godot_collisionobject2d.CollisionObject2D'   ) -> None:
    ...
    self._ptr.call_with_return(319,tuple([node._ptr]))
  ...
  def set_collision_mask(self, mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(321,tuple([mask]))
  ...
  def set_collision_mask_value(self, layer_number:'int'   , value:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(323,tuple([layer_number, value]))
  ...
  def get_collision_mask_value(self, layer_number:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(324,tuple([layer_number]))
    return _ret
  ...
  def set_hit_from_inside(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(331,tuple([enable]))
