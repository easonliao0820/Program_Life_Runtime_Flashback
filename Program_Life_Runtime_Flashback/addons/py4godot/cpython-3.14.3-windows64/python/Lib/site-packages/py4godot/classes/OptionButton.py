...
class OptionButton(py4godot_button.Button):
  ...
  def add_item(self, label:'str'   , id:'int' =-1  ) -> None:
    ...
    self._ptr.call_with_return(489,tuple([py_string_label._ptr, id]))
  ...
  def add_icon_item(self, texture:'py4godot_texture2d.Texture2D'   , label:'str'   , id:'int' =-1  ) -> None:
    ...
    self._ptr.call_with_return(490,tuple([texture._ptr, py_string_label._ptr, id]))
  ...
  def set_item_text(self, idx:'int'   , text:'str'   ) -> None:
    ...
    self._ptr.call_with_return(491,tuple([idx, py_string_text._ptr]))
  ...
  def set_item_icon(self, idx:'int'   , texture:'py4godot_texture2d.Texture2D'   ) -> None:
    ...
    self._ptr.call_with_return(492,tuple([idx, texture._ptr]))
  ...
  def set_item_disabled(self, idx:'int'   , disabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(493,tuple([idx, disabled]))
  ...
  def set_item_id(self, idx:'int'   , id:'int'   ) -> None:
    ...
    self._ptr.call_with_return(494,tuple([idx, id]))
  ...
  def set_item_metadata(self, idx:'int'   , metadata:'object'   ) -> None:
    ...
    self._ptr.call_with_return(495,tuple([idx, metadata]))
  ...
  def set_item_tooltip(self, idx:'int'   , tooltip:'str'   ) -> None:
    ...
    self._ptr.call_with_return(496,tuple([idx, py_string_tooltip._ptr]))
  ...
  def set_item_auto_translate_mode(self, idx:'int'   , mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(497,tuple([idx, mode]))
  ...
  def get_item_icon(self, idx:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(499,tuple([idx]))
  ...
  def get_item_index(self, id:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(501,tuple([id]))
    return _ret
  ...
  def get_item_metadata(self, idx:'int'   ) -> typing.Union[typing.Any]:
    ...
    _ret = None
    _ret = self._ptr.call_with_return(502,tuple([idx]))
    return _ret
  ...
  def get_item_tooltip(self, idx:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(503,tuple([idx]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def get_item_auto_translate_mode(self, idx:'int'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = self._ptr.call_with_return(504,tuple([idx]))
    return _ret
  ...
  def is_item_disabled(self, idx:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(505,tuple([idx]))
    return _ret
  ...
  def is_item_separator(self, idx:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(506,tuple([idx]))
    return _ret
  ...
  def add_separator(self, text:'str' =""  ) -> None:
    ...
    self._ptr.call_with_return(507,tuple([py_string_text._ptr]))
  ...
  def clear(self) -> None:
    ...
    self._ptr.call_with_return(508,tuple([]))
  ...
  def select(self, idx:'int'   ) -> None:
    ...
    self._ptr.call_with_return(509,tuple([idx]))
  ...
  def remove_item(self, idx:'int'   ) -> None:
    ...
    self._ptr.call_with_return(513,tuple([idx]))
  ...
  def set_item_count(self, count:'int'   ) -> None:
    ...
    self._ptr.call_with_return(516,tuple([count]))
  ...
  def get_selectable_item(self, from_last:'bool' =False  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(519,tuple([from_last]))
    return _ret
  ...
  def set_fit_to_longest_item(self, fit:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(520,tuple([fit]))
  ...
  def set_disable_shortcuts(self, disabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(524,tuple([disabled]))
