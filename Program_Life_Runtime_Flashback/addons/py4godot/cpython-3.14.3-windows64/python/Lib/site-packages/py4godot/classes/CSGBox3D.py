...
class CSGBox3D(py4godot_csgprimitive3d.CSGPrimitive3D):
  ...
  def size(self,  value:'Vector3'):
    self.set_size(value)
  @property
  def material(self) -> typing.Union['py4godot_standardmaterial3d.StandardMaterial3D','py4godot_basematerial3d.BaseMaterial3D','py4godot_ormmaterial3d.ORMMaterial3D']:
    r''''''
