...
class ShapeCast2D(py4godot_node2d.Node2D):
  ...
  def set_enabled(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(305,tuple([enabled]))
  ...
  def set_shape(self, shape:'py4godot_shape2d.Shape2D'   ) -> None:
    ...
    self._ptr.call_with_return(307,tuple([shape._ptr]))
  ...
  def set_target_position(self, local_point:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(309,tuple([local_point._ptr]))
  ...
  def set_max_results(self, max_results:'int'   ) -> None:
    ...
    self._ptr.call_with_return(313,tuple([max_results]))
  ...
  def get_collider(self, index:'int'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(318,tuple([index]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def get_collider_shape(self, index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(320,tuple([index]))
    return _ret
  ...
  def get_collision_point(self, index:'int'   ) -> typing.Union['Vector2']:
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(321,tuple([index]))
    return _ret
  ...
  def get_collision_normal(self, index:'int'   ) -> typing.Union['Vector2']:
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(322,tuple([index]))
    return _ret
  ...
  def remove_exception_rid(self, rid:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(327,tuple([rid._ptr]))
  ...
  def remove_exception(self, node:'py4godot_collisionobject2d.CollisionObject2D'   ) -> None:
    ...
    self._ptr.call_with_return(328,tuple([node._ptr]))
  ...
  def set_collision_mask(self, mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(330,tuple([mask]))
  ...
  def set_collision_mask_value(self, layer_number:'int'   , value:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(332,tuple([layer_number, value]))
  ...
  def get_collision_mask_value(self, layer_number:'int'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(333,tuple([layer_number]))
    return _ret
  ...
  def set_exclude_parent_body(self, mask:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(334,tuple([mask]))
  ...
  def set_collide_with_bodies(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(338,tuple([enable]))
