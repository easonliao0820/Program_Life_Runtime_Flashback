...
class EditorFileDialog(py4godot_filedialog.FileDialog):
  r'''
  ...
  def add_side_menu(self, menu:'py4godot_control.Control'   , title:'str' =""  ) -> None:
    ...
    self._ptr.call_with_return(501,tuple([menu._ptr, py_string_title._ptr]))
  ...
  def set_disable_overwrite_warning(self, disable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(502,tuple([disable]))
