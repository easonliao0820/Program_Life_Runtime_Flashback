...
class BoxContainer(py4godot_container.Container):
  ...
  def add_spacer(self, begin:'bool'   ) -> typing.Any:
    ...
    _ret._ptr = self._ptr.call_with_return(442,tuple([begin]))
  ...
  def set_alignment(self, alignment:'int'  ) -> None:
    ...
    self._ptr.call_with_return(443,tuple([alignment]))
  ...
  def set_vertical(self, vertical:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(445,tuple([vertical]))
