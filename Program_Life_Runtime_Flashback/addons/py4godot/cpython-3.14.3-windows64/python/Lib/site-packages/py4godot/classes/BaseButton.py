...
class BaseButton(py4godot_control.Control):
  ...
  def _toggled(self, toggled_on:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(439,tuple([toggled_on]))
  ...
  def set_pressed(self, pressed:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(440,tuple([pressed]))
  ...
  def set_pressed_no_signal(self, pressed:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(442,tuple([pressed]))
  ...
  def set_disabled(self, disabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(448,tuple([disabled]))
  ...
  def set_action_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(450,tuple([mode]))
  ...
  def set_button_mask(self, mask:'int'   ) -> None:
    ...
    self._ptr.call_with_return(452,tuple([mask]))
  ...
  def set_keep_pressed_outside(self, enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(455,tuple([enabled]))
  ...
  def set_shortcut(self, shortcut:'py4godot_shortcut.Shortcut'   ) -> None:
    ...
    self._ptr.call_with_return(459,tuple([shortcut._ptr]))
  ...
  def set_button_group(self, button_group:'py4godot_buttongroup.ButtonGroup'   ) -> None:
    ...
    self._ptr.call_with_return(461,tuple([button_group._ptr]))
