...
class LinkButton(py4godot_basebutton.BaseButton):
  ...
  def set_ellipsis_char(self, char:'str'   ) -> None:
    ...
    self._ptr.call_with_return(467,tuple([py__string_char._ptr]))
  ...
  def set_text_direction(self, direction:'int'  ) -> None:
    ...
    self._ptr.call_with_return(469,tuple([direction]))
  ...
  def set_language(self, language:'str'   ) -> None:
    ...
    self._ptr.call_with_return(471,tuple([py__string_language._ptr]))
  ...
  def set_uri(self, uri:'str'   ) -> None:
    ...
    self._ptr.call_with_return(473,tuple([py__string_uri._ptr]))
  ...
  def set_underline_mode(self, underline_mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(475,tuple([underline_mode]))
