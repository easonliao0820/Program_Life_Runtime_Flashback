...
class Engine(py4godot_object.Object):
  ...
  def instance():
    ...
    if _Engine_singleton_instance is None:
      singleton = Engine()
      singleton._ptr = constructor(875,0, ())
  ...
  @functools.native_method
  def get_main_loop(self) -> typing.Union['py4godot_scenetree.SceneTree','py4godot_mainloop.MainLoop']:
    r'''
  ...
  @functools.native_method
  def get_script_language(self, index:'int'   ) -> typing.Union['py4godot_scriptlanguage.ScriptLanguage','py4godot_scriptlanguageextension.ScriptLanguageExtension']:
    r'''
