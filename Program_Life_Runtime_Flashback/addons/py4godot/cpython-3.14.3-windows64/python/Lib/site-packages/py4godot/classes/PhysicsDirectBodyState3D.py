...
class PhysicsDirectBodyState3D(py4godot_object.Object):
  ...
  @functools.native_method
  def get_space_state(self) -> typing.Union['py4godot_physicsdirectspacestate3dextension.PhysicsDirectSpaceState3DExtension','py4godot_physicsdirectspacestate3d.PhysicsDirectSpaceState3D']:
    r'''
...
register_cast_function('GodotPhysicsDirectBodyState3D', PhysicsDirectBodyState3D.cast)
register_cast_function('JoltPhysicsDirectBodyState3D', PhysicsDirectBodyState3D.cast)
register_class('PhysicsDirectBodyState3D', PhysicsDirectBodyState3D)
register_class('GodotPhysicsDirectBodyState3D', PhysicsDirectBodyState3D)
register_class('JoltPhysicsDirectBodyState3D', PhysicsDirectBodyState3D)
