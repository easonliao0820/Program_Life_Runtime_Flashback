...
class World3D(py4godot_resource.Resource):
  ...
  def scenario(self) -> typing.Union['RID']:
    ...
    return _ret
  @property
  def direct_space_state(self) -> typing.Union['py4godot_physicsdirectspacestate3dextension.PhysicsDirectSpaceState3DExtension','py4godot_physicsdirectspacestate3d.PhysicsDirectSpaceState3D']:
    r''''''
  ...
  @functools.native_method
  def get_direct_space_state(self) -> typing.Union['py4godot_physicsdirectspacestate3dextension.PhysicsDirectSpaceState3DExtension','py4godot_physicsdirectspacestate3d.PhysicsDirectSpaceState3D']:
    r''''''
