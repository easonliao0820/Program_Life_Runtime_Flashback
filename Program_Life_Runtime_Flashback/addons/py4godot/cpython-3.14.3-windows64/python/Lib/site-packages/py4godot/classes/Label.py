...
class Label(py4godot_control.Control):
  ...
  def set_vertical_alignment(self, alignment:'int'  ) -> None:
    ...
    self._ptr.call_with_return(440,tuple([alignment]))
  ...
  def set_text(self, text:'str'   ) -> None:
    ...
    self._ptr.call_with_return(442,tuple([py__string_text._ptr]))
  ...
  def set_label_settings(self, settings:'py4godot_labelsettings.LabelSettings'   ) -> None:
    ...
    self._ptr.call_with_return(444,tuple([settings._ptr]))
  ...
  def set_text_direction(self, direction:'int'  ) -> None:
    ...
    self._ptr.call_with_return(446,tuple([direction]))
  ...
  def set_language(self, language:'str'   ) -> None:
    ...
    self._ptr.call_with_return(448,tuple([py__string_language._ptr]))
  ...
  def set_paragraph_separator(self, paragraph_separator:'str'   ) -> None:
    ...
    self._ptr.call_with_return(450,tuple([py__string_paragraph_separator._ptr]))
  ...
  def set_autowrap_mode(self, autowrap_mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(452,tuple([autowrap_mode]))
  ...
  def set_autowrap_trim_flags(self, autowrap_trim_flags:'int'   ) -> None:
    ...
    self._ptr.call_with_return(454,tuple([autowrap_trim_flags]))
  ...
  def set_justification_flags(self, justification_flags:'int'   ) -> None:
    ...
    self._ptr.call_with_return(456,tuple([justification_flags]))
  ...
  def set_clip_text(self, enable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(458,tuple([enable]))
  ...
  def set_tab_stops(self, tab_stops:'PackedFloat32Array'   ) -> None:
    ...
    self._ptr.call_with_return(460,tuple([tab_stops._ptr]))
  ...
  def set_text_overrun_behavior(self, overrun_behavior:'int'  ) -> None:
    ...
    self._ptr.call_with_return(462,tuple([overrun_behavior]))
  ...
  def set_ellipsis_char(self, char:'str'   ) -> None:
    ...
    self._ptr.call_with_return(464,tuple([py__string_char._ptr]))
  ...
  def get_line_height(self, line:'int' =-1  ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(468,tuple([line]))
    return _ret
  ...
  def set_visible_characters(self, amount:'int'   ) -> None:
    ...
    self._ptr.call_with_return(472,tuple([amount]))
  ...
  def set_visible_characters_behavior(self, behavior:'int'  ) -> None:
    ...
    self._ptr.call_with_return(475,tuple([behavior]))
  ...
  def set_visible_ratio(self, ratio:'float'   ) -> None:
    ...
    self._ptr.call_with_return(476,tuple([ratio]))
  ...
  def set_lines_skipped(self, lines_skipped:'int'   ) -> None:
    ...
    self._ptr.call_with_return(478,tuple([lines_skipped]))
  ...
  def set_max_lines_visible(self, lines_visible:'int'   ) -> None:
    ...
    self._ptr.call_with_return(480,tuple([lines_visible]))
  ...
  def get_character_bounds(self, pos:'int'   ) -> typing.Union['Rect2']:
    ...
    _ret._ptr = self._ptr.call_with_return(486,tuple([pos]))
    return _ret
