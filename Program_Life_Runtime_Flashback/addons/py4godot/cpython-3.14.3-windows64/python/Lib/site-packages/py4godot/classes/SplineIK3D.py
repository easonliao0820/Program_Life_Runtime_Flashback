...
from py4godot.wrappers.wrappers import CPPSplineIK3DWrapper


class SplineIK3D(py4godot_chainik3d.ChainIK3D):
  r'''
  ...
  @staticmethod
  def constructor():
    class_ = SplineIK3D.construct_without_init()
  ...
  def new():
    ...
    return class_
  def __init__(self):
    self._ptr =  CPPSplineIK3DWrapper()
  ...
  def generate_wrapper(self):
    return CPPSplineIK3DWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = SplineIK3D.__new__(SplineIK3D)
  ...
  def cast(other:'Object'):
    ...
    cls = SplineIK3D.construct_without_init()
    cls._ptr = CPPSplineIK3DWrapper()
  ...
  def set_path_3d(self, index:'int'   , path_3d:'object'   ) -> None:
    r'''
				Sets the node path of the `Path3D` which is describing the path.
			'''

    assert isinstance(index, (int, float)), 'index must be int or float'
    assert(not path_3d is None)
    assert isinstance(path_3d, (str, NodePath)), 'path_3d must be str or NodePath'
    ...
    assert(isinstance(path_3d, (str, NodePath)))
    py_nodepath_path_3d = path_3d if isinstance(path_3d,NodePath) else NodePath.new2(path_3d)

    self._ptr.call_with_return(283,tuple([index, py_nodepath_path_3d._ptr]))

  @functools.native_method
  def get_path_3d(self, index:'int'   ) -> typing.Union['NodePath']:
    r'''
    ...
    _ret._ptr = self._ptr.call_with_return(284,tuple([index]))
    return _ret


  @functools.native_method
  def set_tilt_enabled(self, index:'int'   , enabled:'bool'   ) -> None:
    r'''
  ...
  @functools.native_method
  def is_tilt_enabled(self, index:'int'   ) -> typing.Union[bool]:
    r'''
  ...
  @functools.native_method
  def set_tilt_fade_in(self, index:'int'   , size:'int'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(287,tuple([index, size]))

  @functools.native_method
  def get_tilt_fade_in(self, index:'int'   ) -> typing.Union[int]:
    r'''
  ...
  @functools.native_method
  def set_tilt_fade_out(self, index:'int'   , size:'int'   ) -> None:
    r'''
    ...
    self._ptr.call_with_return(289,tuple([index, size]))

  @functools.native_method
  def get_tilt_fade_out(self, index:'int'   ) -> typing.Union[int]:
    r'''
...
register_cast_function('SplineIK3D', SplineIK3D.cast)
register_class('SplineIK3D', SplineIK3D)
