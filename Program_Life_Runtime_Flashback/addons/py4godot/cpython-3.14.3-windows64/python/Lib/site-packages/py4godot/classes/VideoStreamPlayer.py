...
class VideoStreamPlayer(py4godot_control.Control):
  ...
  def set_stream(self, stream:'py4godot_videostream.VideoStream'   ) -> None:
    ...
    self._ptr.call_with_return(438,tuple([stream._ptr]))
  ...
  def set_paused(self, paused:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(443,tuple([paused]))
  ...
  def set_loop(self, loop:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(445,tuple([loop]))
  ...
  def set_volume(self, volume:'float'   ) -> None:
    ...
    self._ptr.call_with_return(447,tuple([volume]))
  ...
  def set_volume_db(self, db:'float'   ) -> None:
    ...
    self._ptr.call_with_return(449,tuple([db]))
  ...
  def set_speed_scale(self, speed_scale:'float'   ) -> None:
    ...
    self._ptr.call_with_return(451,tuple([speed_scale]))
  ...
  def set_audio_track(self, track:'int'   ) -> None:
    ...
    self._ptr.call_with_return(453,tuple([track]))
  ...
  def set_stream_position(self, position:'float'   ) -> None:
    ...
    self._ptr.call_with_return(457,tuple([position]))
  ...
  def set_buffering_msec(self, msec:'int'   ) -> None:
    ...
    self._ptr.call_with_return(463,tuple([msec]))
  ...
  def set_bus(self, bus:'object'   ) -> None:
    ...
    self._ptr.call_with_return(465,tuple([py_stringname_bus._ptr]))
