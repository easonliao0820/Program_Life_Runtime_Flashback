...
class FileDialog(py4godot_confirmationdialog.ConfirmationDialog):
  ...
  @property
  def overwrite_warning_enabled(self) -> typing.Union[bool]:
    r''''''
    _ret = self. is_customization_flag_enabled(7)
    return _ret
  @overwrite_warning_enabled.setter
  def overwrite_warning_enabled(self,  value:'bool'):
    self.set_customization_flag_enabled(7, value)
  @property
  def deleting_enabled(self) -> typing.Union[bool]:
    r''''''
    _ret = self. is_customization_flag_enabled(8)
    return _ret
  @deleting_enabled.setter
  def deleting_enabled(self,  value:'bool'):
    self.set_customization_flag_enabled(8, value)
  @property
  ...
  @functools.native_method
  def add_filter(self, filter:'str'   , description:'str' =""  , mime_type:'str' =""  ) -> None:
    r'''
    ...
    self._ptr.call_with_return(458,tuple([py_string_filter._ptr, py_string_description._ptr, py_string_mime_type._ptr]))
  ...
  def set_filters(self, filters:'PackedStringArray'   ) -> None:
    ...
    self._ptr.call_with_return(459,tuple([filters._ptr]))
  ...
  def clear_filename_filter(self) -> None:
    ...
    self._ptr.call_with_return(461,tuple([]))
  ...
  def set_filename_filter(self, filter:'str'   ) -> None:
    ...
    self._ptr.call_with_return(462,tuple([py__string_filter._ptr]))
  ...
  def get_option_name(self, option:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(464,tuple([option]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def get_option_values(self, option:'int'   ) -> typing.Union['PackedStringArray']:
    ...
    _ret = PackedStringArray.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(465,tuple([option]))
    return _ret
  ...
  def get_option_default(self, option:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(466,tuple([option]))
    return _ret
  ...
  def set_option_name(self, option:'int'   , name:'str'   ) -> None:
    ...
    self._ptr.call_with_return(467,tuple([option, py_string_name._ptr]))
  ...
  def set_option_values(self, option:'int'   , values:'PackedStringArray'   ) -> None:
    ...
    self._ptr.call_with_return(468,tuple([option, values._ptr]))
  ...
  def set_option_default(self, option:'int'   , default_value_index:'int'   ) -> None:
    ...
    self._ptr.call_with_return(469,tuple([option, default_value_index]))
  ...
  def set_option_count(self, count:'int'   ) -> None:
    ...
    self._ptr.call_with_return(470,tuple([count]))
  ...
  def add_option(self, name:'str'   , values:'PackedStringArray'   , default_value_index:'int'   ) -> None:
    ...
    self._ptr.call_with_return(472,tuple([py_string_name._ptr, values._ptr, default_value_index]))
  ...
  def set_current_dir(self, dir:'str'   ) -> None:
    ...
    self._ptr.call_with_return(477,tuple([py__string_dir._ptr]))
  ...
  def set_current_file(self, file:'str'   ) -> None:
    ...
    self._ptr.call_with_return(478,tuple([py__string_file._ptr]))
  ...
  def set_current_path(self, path:'str'   ) -> None:
    ...
    self._ptr.call_with_return(479,tuple([py__string_path._ptr]))
  ...
  def set_mode_overrides_title(self, override:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(480,tuple([override]))
  ...
  def set_file_mode(self, mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(482,tuple([mode]))
  ...
  @functools.native_method
  def get_vbox(self) -> typing.Union['py4godot_scripteditorbase.ScriptEditorBase','py4godot_colorpicker.ColorPicker','py4godot_vboxcontainer.VBoxContainer']:
    r'''
  ...
  def set_access(self, access:'int'  ) -> None:
    ...
    self._ptr.call_with_return(488,tuple([access]))
  ...
  def set_root_subfolder(self, dir:'str'   ) -> None:
    ...
    self._ptr.call_with_return(490,tuple([py__string_dir._ptr]))
  ...
  def get_root_subfolder(self) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(491,tuple([]))
  ...
  def set_show_hidden_files(self, show:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(492,tuple([show]))
  ...
  def set_use_native_dialog(self, native:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(494,tuple([native]))
  ...
  def set_customization_flag_enabled(self, flag:'int'  , enabled:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(496,tuple([flag, enabled]))
  ...
  def is_customization_flag_enabled(self, flag:'int'  ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(497,tuple([flag]))
  ...
  def deselect_all(self) -> None:
    ...
    self._ptr.call_with_return(498,tuple([]))

  @staticmethod
  def set_favorite_list(favorites:'PackedStringArray'   ) -> None:
    r'''
    ...
    assert(not favorites is None)
    assert isinstance(favorites, PackedStringArray), 'favorites must be PackedStringArray'
    ...
    static_method(958,3,tuple([favorites._ptr]))

  @staticmethod
  def get_favorite_list() -> typing.Union['PackedStringArray']:
    r'''
    ...
    _ret = PackedStringArray.construct_without_init()
    _ret._ptr = static_method(958,4,tuple([]))
    return _ret


  @staticmethod
  def set_recent_list(recents:'PackedStringArray'   ) -> None:
    r'''
    ...
    assert(not recents is None)
    assert isinstance(recents, PackedStringArray), 'recents must be PackedStringArray'
    ...
    static_method(958,5,tuple([recents._ptr]))

  @staticmethod
  def get_recent_list() -> typing.Union['PackedStringArray']:
    r'''
    ...
    _ret = PackedStringArray.construct_without_init()
    _ret._ptr = static_method(958,6,tuple([]))
    return _ret


  @staticmethod
  def set_get_icon_callback(callback:'Callable'   ) -> None:
    r'''
    ...
    static_method(958,7,tuple([callback._ptr]))

  @staticmethod
  def set_get_thumbnail_callback(callback:'Callable'   ) -> None:
    r'''
    ...
    static_method(958,8,tuple([callback._ptr]))
  ...
  def popup_file_dialog(self) -> None:
    ...
    self._ptr.call_with_return(499,tuple([]))
  ...
  def invalidate(self) -> None:
    ...
    self._ptr.call_with_return(500,tuple([]))
