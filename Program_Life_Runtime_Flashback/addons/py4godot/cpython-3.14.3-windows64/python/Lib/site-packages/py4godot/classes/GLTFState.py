...
class GLTFState(py4godot_resource.Resource):
  ...
  @property
  def handle_binary_image_mode(self) -> typing.Union[int]:
    r''''''
    _ret = self. get_handle_binary_image_mode()
    return _ret
  @handle_binary_image_mode.setter
  def handle_binary_image_mode(self,  value:'int'):
    self.set_handle_binary_image_mode(value)
  @property
  ...
  @functools.native_method
  def get_animation_players_count(self, anim_player_index:'int'   ) -> typing.Union[int]:
    r''''''

    assert isinstance(anim_player_index, (int, float)), 'anim_player_index must be int or float'
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(102,tuple([anim_player_index]))
    return _ret


  @functools.native_method
  def get_animation_player(self, anim_player_index:'int'   ) -> typing.Union['py4godot_animationplayer.AnimationPlayer']:
    r''''''
    ...
    _ret._ptr = self._ptr.call_with_return(103,tuple([anim_player_index]))
  ...
  @functools.native_method
  def get_scene_node(self, gltf_node_index:'int'   ) -> typing.Any:
    r''''''
    ...
    _ret._ptr = self._ptr.call_with_return(138,tuple([gltf_node_index]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  @functools.native_method
  def get_handle_binary_image_mode(self) -> typing.Union[int]:
    r''''''
  ...
  @functools.native_method
  def set_handle_binary_image_mode(self, method:'int'  ) -> None:
    r''''''

    assert isinstance(method, (int, float)), 'method must be int or float'


    self.py__handle_binary_image_mode = method
  ...
  def set_handle_binary_image(self, method:'int'   ) -> None:
    ...
    self._ptr.call_with_return(147,tuple([method]))
