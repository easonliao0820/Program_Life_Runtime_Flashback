...
class WebRTCPeerConnection(py4godot_refcounted.RefCounted):
  ...
  def set_default_extension(extension_class:'object'   ) -> None:
    ...
    static_method(881,0,tuple([py_stringname_extension_class._ptr]))
  ...
  @functools.native_method
  def create_data_channel(self, label:'str'   , options:'Dictionary' = None  ) -> typing.Union['py4godot_webrtcdatachannelextension.WebRTCDataChannelExtension','py4godot_webrtcdatachannel.WebRTCDataChannel']:
    r''''''
    if options is None:
