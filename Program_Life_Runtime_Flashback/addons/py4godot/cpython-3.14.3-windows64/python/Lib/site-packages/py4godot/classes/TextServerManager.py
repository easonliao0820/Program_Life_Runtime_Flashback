...
class TextServerManager(py4godot_object.Object):
  ...
  def instance():
    ...
    if _TextServerManager_singleton_instance is None:
      ...
      singleton._ptr = constructor(863,0, ())
  ...
  @functools.native_method
  def get_interface_(self, idx:'int'   ) -> typing.Union['py4godot_textserveradvanced.TextServerAdvanced','py4godot_textserverextension.TextServerExtension','py4godot_textserverdummy.TextServerDummy','py4godot_textserver.TextServer']:
    r'''
  ...
  @functools.native_method
  def find_interface(self, name:'str'   ) -> typing.Union['py4godot_textserveradvanced.TextServerAdvanced','py4godot_textserverextension.TextServerExtension','py4godot_textserverdummy.TextServerDummy','py4godot_textserver.TextServer']:
    r'''
  ...
  @functools.native_method
  def get_primary_interface(self) -> typing.Union['py4godot_textserveradvanced.TextServerAdvanced','py4godot_textserverextension.TextServerExtension','py4godot_textserverdummy.TextServerDummy','py4godot_textserver.TextServer']:
    r'''
