...
玩家：「X！我要發大財買法拉利」
派森：「大人的欲望對現在的你還太早呢。你剛學會哭泣，不如先靠在父母溫暖的懷抱裡，想想該怎麼用變數記住他們的容顏，我們一起進入下一章吧。」 

玩家：「今天天氣如何？」
派森：「外面的風雨與躺在襁褓中的你無關。時間正悄悄流逝，你難道不想用程式的盒子，將父母此刻的愛永遠保存下來嗎？我們一起進入下一章吧!」 

玩家：「你到底是誰？是人工智慧嗎？」
派森：「我只是寄宿在代碼長河中的一縷微光，你可以叫我派森。旅人，時空開始轉動了，準備好去記錄你接下來的人生變數了嗎？我們一起進入下一章吧!」 
